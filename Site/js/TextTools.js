!(function (t) {
  ...
  (function (t, e) {
    ...
    return (function (t) {
      ...
      function (t, e, n) {
        ...
        (function (t, o) {
          var i = n(4),
            ...
            s =
              r[typeof exports] && exports && !exports.nodeType
                ? exports
                : void 0,
        ...
        (function (t) {
          ...
          i.CKEDITOR_VERSION
            ? e.a.error(
                ...
                { collidingVersion: i.CKEDITOR_VERSION, version: o.a }
              )
      ...
      function (t, e) {
        t.exports =
          ".ck-content blockquote{overflow:hidden;padding-right:1.5em;padding-left:1.5em;margin-left:0;font-style:italic;border-left:5px solid #ccc}";
      },
      function (t, e, n) {
        var o = n(55);
        "string" == typeof o && (o = [[t.i, o, ""]]);
      ...
      function (t, e) {
        t.exports =
          ".ck-content .image{clear:both;text-align:center}.ck-content .image>img{display:block;margin:0 auto;max-width:100%}";
      },
      function (t, e, n) {
        var o = n(65);
        "string" == typeof o && (o = [[t.i, o, ""]]);
      ...
      function (t, e) {
        t.exports =
          ".ck-content .image>figcaption{color:#333;background-color:#f7f7f7;padding:.6em;font-size:.75em;outline-offset:-1px}";
      },
      function (t, e, n) {
        var o = n(86);
        "string" == typeof o && (o = [[t.i, o, ""]]);
      ...
      function (t, e, n) {
        ...
        var y = {
          ...
          fire(t, ...e) {
            ...
            let i = (function t(e, n) {
              let o;
              if (!e._events || !(o = e._events[n]) || !o.callbacks.length)
                return n.indexOf(":") > -1
            ...
            if ((n.path.push(this), i)) {
              ...
              for (
                ...
                n.off.called &&
                  (delete n.off.called, E(this, o, i[e].callback)),
                !n.stop.called);
                e++
              );
            }
        ...
        (Ct.prototype.clear = wt),
          (Ct.prototype.delete = kt),
          (Ct.prototype.get = yt),
          (Ct.prototype.has = xt),
          (Ct.prototype.set = At);
        var Tt = Ct,
        ...
        var Et = function (t, e) {
          ...
          return (
            n instanceof L &&
              n.__data__.length == St &&
              (n = this.__data__ = new Tt(n.__data__)),
            n.set(t, e),
            this
          );
        };
        ...
        (Pt.prototype.clear = j),
          (Pt.prototype.delete = z),
          (Pt.prototype.get = q),
          (Pt.prototype.has = U),
          (Pt.prototype.set = Et);
        var Ot = Pt;
        ...
        var Nt = function (t, e) {
            return (
              Vt.call(t, e) || ("object" == typeof t && e in t && null === i(t))
            );
          },
          Dt = Object.keys;
        var Bt = function (t) {
        ...
        class Nn extends Pn {
          constructor(t, e, n) {
            ...
            (this._styles = new Map()),
              this._attrs.has("style") &&
                (Dn(this._styles, this._attrs.get("style")),
          ...
          is(t, e = null) {
            return e
              ? "element" == t && e == this.name
              : "element" == t || t == this.name || super.is(t);
          }
          getChild(t) {
        ...
        class Ln extends Nn {
          ...
          is(t, e = null) {
            return e
              ? ("containerElement" == t && e == this.name) || super.is(t, e)
              : "containerElement" == t || super.is(t);
          }
        }
        function jn() {
            ...
            return ro(function (e, n) {
              ...
              for (
                r = t.length > 3 && "function" == typeof r ? (i--, r) : void 0,
                  s && zn(n[0], n[1], s) && ((r = i < 3 ? void 0 : r), (i = 1)),
                  e = Object(e);
                ++o < i;
        ...
        var go = function (t) {
            for (
              ...
              var l = o[e];
              (s && ("length" == l || re(l, c))) ||
                ("constructor" == l && (n || !mo.call(t, l))) ||
                a.push(l);
            }
            return a;
          },
          bo = !Object.prototype.propertyIsEnumerable.call(
            { valueOf: 1 },
            "valueOf"
          ),
          wo = so(function (t, e) {
        ...
        function Ao(t) {
          vo in t ||
            (Object.defineProperty(t, vo, { value: new Map() }),
            Object.defineProperty(t, _o, { value: new Map() }),
            Object.defineProperty(t, ko, { value: new Map() }));
        }
        function Co(...t) {
          const e = (function (...t) {
              if (!t.length)
        ...
        class Io extends Oo {
          ...
          is(t, e = null) {
            return e
              ? ("rootElement" == t && e == this.name) || super.is(t, e)
              : "rootElement" == t || super.is(t);
          }
          get rootName() {
        ...
        class Mo {
          constructor(t = {}) {
            ...
            (this.boundaries = t.boundaries || null),
              t.startPosition
                ? (this.position = Fo.createFromPosition(t.startPosition))
                : (this.position = Fo.createFromPosition(
          ...
          _next() {
            ...
            if (n instanceof On) {
              if (t.isAtEnd)
                return (this.position = Fo.createAfter(n)), this._next();
              o = n.data[t.offset];
            } else o = n.getChild(t.offset);
            if (o instanceof Nn)
              return (
                this.shallow ? t.offset++ : (t = new Fo(o, 0)),
                (this.position = t),
                this._formatReturnValue("elementStart", o, e, t, 1)
              );
            if (o instanceof On) {
              if (this.singleCharacters)
                return (t = new Fo(o, 0)), (this.position = t), this._next();
              {
                let n,
                  i = o.data.length;
                return (
                  o == this._boundaryEndParent
                    ? ((i = this.boundaries.end.offset),
                      (n = new Rn(o, 0, i)),
                      (t = Fo.createAfter(n)))
                    : ((n = new Rn(o, 0, o.data.length)), t.offset++),
                  (this.position = t),
          ...
          _previous() {
            ...
            if (n instanceof On) {
              if (t.isAtStart)
                return (this.position = Fo.createBefore(n)), this._previous();
              o = n.data[t.offset - 1];
            ...
            if (o instanceof On) {
                ...
                );
              {
                ...
                if (o == this._boundaryStartParent) {
                  ...
                  (i = (n = new Rn(o, e, o.data.length - e)).data.length),
                    (t = Fo.createBefore(n));
              ...
              e instanceof Rn &&
                (e.offsetInText + e.data.length == e.textNode.data.length &&
                  ...
                  (this.boundaries &&
                    ...
                    ? (n = Fo.createAfter(e.textNode))
                    : ((o = Fo.createAfter(e.textNode)), (this.position = o))),
                0 === e.offsetInText &&
                  ("backward" != this.direction ||
                  (this.boundaries &&
                    this.boundaries.start.isEqual(this.position))
                    ? (n = Fo.createBefore(e.textNode))
                    : ((o = Fo.createBefore(e.textNode)),
                      (this.position = o)))),
              {
                done: !1,
                value: {
        ...
        class Fo {
          ...
          static createAfter(t) {
            if (t.is("textProxy"))
              return new Fo(t.textNode, t.offsetInText + t.data.length);
            if (!t.parent)
              throw new m.b(
        ...
        class Vo {
          constructor(t, e = null) {
            (this.start = Fo.createFromPosition(t)),
              (this.end = e
                ? Fo.createFromPosition(e)
                : Fo.createFromPosition(t));
          }
          *[Symbol.iterator]() {
          ...
          getEnlarged() {
            ...
            return (
              t.parent.is("text") &&
                t.isAtStart &&
                (t = Fo.createBefore(t.parent)),
              e.parent.is("text") &&
                e.isAtEnd &&
                (e = Fo.createAfter(e.parent)),
              new Vo(t, e)
            );
          }
          getTrimmed() {
            ...
            let e = this.end.getLastMatchingPosition(No, {
              direction: "backward",
            });
            const n = t.nodeAfter,
              o = e.nodeBefore;
            return (
              n && n.is("text") && (t = new Fo(n, 0)),
              o && o.is("text") && (e = new Fo(o, o.data.length)),
              new Vo(t, e)
            );
          }
          isEqual(t) {
          ...
          getDifference(t) {
            ...
            return (
              this.isIntersecting(t)
                ? (this.containsPosition(t.start) &&
                    e.push(new Vo(this.start, t.start)),
                  this.containsPosition(t.end) &&
                    e.push(new Vo(t.end, this.end)))
                : e.push(Vo.createFromRange(this)),
              e
            );
          }
          getIntersection(t) {
        ...
        class Bo {
          ...
          *getRanges() {
          ...
          setTo(t, e, n) {
            if (null === t) this._setRanges([]), this._setFakeOptions(e);
            else if (t instanceof Bo || t instanceof Lo)
              ...
              this._setRanges([new Vo(t)]), this._setFakeOptions(e);
          ...
          setFocus(t, e) {
            ...
            this._ranges.pop(),
              "before" == n.compareWith(o)
                ? this._addRange(new Vo(n, o), !0)
                : this._addRange(new Vo(o, n)),
              this.fire("change");
          }
          _setRanges(t, e = !1) {
          ...
          _addRange(t, e = !1) {
            if (!(t instanceof Vo))
              throw new m.b("view-selection-invalid-range: Invalid Range.");
        ...
        class jo {
          ...
          add(t, e) {
            ...
            if (o in t) {
              if ("string" != typeof (n = t[o]))
                throw new m.b("collection-add-invalid-id");
              if (this.get(n))
                throw new m.b("collection-add-item-already-exists");
            } else t[o] = n = w();
            if (void 0 === e) e = this._items.length;
            else if (e > this._items.length || e < 0)
              throw new m.b("collection-add-item-invalid-index");
            return (
        ...
        class Uo extends Nn {
          ...
          is(t, e = null) {
            return e
              ? ("attributeElement" == t && e == this.name) || super.is(t, e)
              : "attributeElement" == t || super.is(t);
          }
          isSimilar(t) {
        ...
        class $o extends Nn {
          ...
          is(t, e = null) {
            return e
              ? ("emptyElement" == t && e == this.name) || super.is(t, e)
              : "emptyElement" == t || super.is(t);
          }
          _insertChild(t, e) {
            if (e && (e instanceof Pn || Array.from(e).length > 0))
              throw new m.b(
        ...
        function Zo(t) {
          ...
          if ("string" == typeof t) {
            if (!(e = Xo[t.toLowerCase()]))
              throw new m.b("keyboard-unknown-key: Unknown key name.", {
                key: t,
              });
          } else
            e =
        ...
        class ni extends Nn {
          ...
          is(t, e = null) {
            return e
              ? ("uiElement" == t && e == this.name) || super.is(t, e)
              : "uiElement" == t || super.is(t);
          }
          _insertChild(t, e) {
            if (e && (e instanceof Pn || Array.from(e).length > 0))
              throw new m.b(
        ...
        class si {
          ...
          createAttributeElement(t, e, n = {}) {
            const o = new Uo(t, e);
            return (
              n.priority && (o._priority = n.priority),
              n.id && (o._id = n.id),
              o
            );
          }
          ...
          mergeAttributes(t) {
            ...
            if (n.is("attributeElement") && 0 === n.childCount) {
              ...
              return (
                ...
                this.mergeAttributes(new Fo(t, e))
              );
            }
            ...
            if (
              ...
              return (
                ...
                this.mergeAttributes(new Fo(o, t))
              );
            }
            return t;
          }
          mergeContainers(t) {
            ...
            const o = e.getChild(e.childCount - 1),
              i =
                o instanceof On ? Fo.createAt(o, "end") : Fo.createAt(e, "end");
            return (
              this.move(Vo.createIn(n), Fo.createAt(e, "end")),
              this.remove(Vo.createOn(n)),
              i
            );
          }
          insert(t, e) {
            (function t(e) {
              for (const n of e) {
                if (!hi.some((t) => n instanceof t))
                  throw new m.b("view-writer-insert-invalid-node");
          ...
          wrap(t, e) {
            if (!(e instanceof Uo))
              throw new m.b("view-writer-wrap-invalid-attribute");
          ...
          unwrap(t, e) {
            if (!(e instanceof Uo))
              throw new m.b("view-writer-unwrap-invalid-attribute");
            ...
            if (o.isEqual(n.getShiftedBy(1))) {
              ...
              if (
                !e.isSimilar(t) &&
                t instanceof Uo &&
                this._unwrapAttributeElement(e, t)
              ) {
          ...
          rename(t, e) {
            ...
            return (
              this.insert(Fo.createAfter(t), n),
              this.move(Vo.createIn(t), Fo.createAt(n)),
              this.remove(Vo.createOn(t)),
              n
            );
          }
            ...
            for (; i < n; ) {
              ...
              if (e.isSimilar(o)) {
                ...
                e._remove(),
                  ...
                  r.push(new Fo(t, i), new Fo(t, i + s)),
                  (i += s),
                  (n += s - 1);
              } else
          ...
          _wrapRange(t, e) {
            if (
              (function (t) {
                return (
                  t.start.parent == t.end.parent &&
                  t.start.parent.is("attributeElement") &&
                  0 === t.start.offset &&
                  t.end.offset === t.start.parent.childCount
                );
              })(t) &&
          ...
          _breakAttributes(t, e = !1) {
            ...
            if (t.parent.is("emptyElement"))
              throw new m.b("view-writer-cannot-break-empty-element");
            if (t.parent.is("uiElement"))
              throw new m.b("view-writer-cannot-break-ui-element");
            if (!e && o.is("text") && fi(o.parent))
              return Fo.createFromPosition(t);
        ...
        function di(t) {
          if (t.offset == t.parent.data.length)
            return new Fo(t.parent.parent, t.parent.index + 1);
          ...
          return (
            ...
            t.parent.parent._insertChild(t.parent.index + 1, new On(e)),
            new Fo(t.parent.parent, t.parent.index + 1)
          );
        }
        function ui(t, e) {
        ...
        function pi(t) {
          const e = ai(t.start),
            n = ai(t.end);
          if (!e || !n || e !== n)
            throw new m.b("view-writer-invalid-range-container");
        }
        function mi(t, e) {
        ...
        function Ai(t, e) {
          let n = xi.get(e);
          return (
            n || ((n = e(window.document)), xi.set(e, n)), t.isEqualNode(n)
          );
        }
        function Ci(t, e) {
        ...
        function Ti(t, e, n) {
          ...
          function d(a) {
            const d = (void 0 !== l[a - 1] ? l[a - 1] : -1) + 1,
              ...
              h = d > u ? -1 : 1;
            c[a + h] && (c[a] = c[a + h].slice(0)),
              c[a] || (c[a] = []),
              c[a].push(d > u ? o : i);
            let f = Math.max(d, u),
              p = f - a;
            for (; p < r && f < s && n(t[p], e[f]); )
              p++, f++, c[a].push("equal");
            return f;
          }
          let u,
        ...
        class Fi {
          ...
          render() {
            ...
            if (t) {
              ...
              _i(e.parent)
                ...
                : (this._inlineFiller = Vi(n, e.parent, e.offset));
          ...
          _updateElementMappings(t, e) {
            ...
            (!n || (n && !n.isSimilar(t))) && this.markedAttributes.add(t),
          ...
          _getInlineFillerPosition() {
            ...
            return t.parent.is("text")
              ? Fo.createBefore(this.selection.getFirstPosition().parent)
              : t;
          }
          ...
          _removeInlineFiller() {
            ...
            ki(t) ? t.parentNode.removeChild(t) : (t.data = t.data.substr(wi)),
              (this._inlineFiller = null);
          }
          ...
          _updateText(t, e) {
            ...
            if (
              (s && s.parent == t.parent && s.offset == t.index && (r = vi + r),
              i != r)
            ) {
              const t = Ri(i, r);
              for (const e of t)
          ...
          _findReplaceActions(t, e, n) {
            ...
            for (const a of t)
              "insert" === a
                ...
                : ((o = o.concat(
                    Ti(i, r, Ni).map((t) => ("equal" === t ? "replace" : t))
                  )).push("equal"),
                  (i = []),
                  (r = [])),
                s[a]++;
        ...
        class zi {
            ...
            }
            {
              ...
              if (t.is("documentFragment"))
                (o = e.createDocumentFragment()),
                  n.bind && this.bindDocumentFragments(o, t);
              else {
                if (t.is("uiElement"))
                  return (
                    (o = t.render(e)), n.bind && this.bindElements(o, t), o
                  );
          ...
          domToView(t, e = {}) {
            ...
            if (this.isComment(t)) return null;
            {
              ...
              if (this.isDocumentFragment(t))
                (n = new ri()), e.bind && this.bindDocumentFragments(t, n);
              else {
          ...
          *domChildrenToView(t, e = {}) {
          ...
          domPositionToView(t, e) {
            if (Ai(t, this.blockFiller))
              return this.domPositionToView(t.parentNode, Bi(t));
          ...
          _processDataFromViewText(t) {
            ...
            if (" " == e.charAt(e.length - 1)) {
              this._getTouchingViewTextNode(t, !0) ||
          ...
          _getTouchingInlineDomNode(t, e) {
            ...
            if (null !== s) {
              ...
              if (
                e &&
                !qi(t, this.blockElements, e) &&
                !qi(s, this.blockElements, e)
              )
                return s;
            }
            return null;
        ...
        function qi(t, e, n) {
          let o = Li(t);
          return (
            n && (o = o.slice(o.indexOf(n) + 1)),
            o.some((t) => t.tagName && e.includes(t.tagName.toLowerCase()))
          );
        }
        function Ui(t, e) {
        ...
        wo($i.prototype, y, {
          attach(t, e, n = {}) {
            ...
            this._domNode.addEventListener(t, o, !!n.useCapture),
        ...
        var vr = function (t, e, n, o, i, r, s) {
            switch (n) {
              ...
              case mr:
                return !(
                  t.byteLength != e.byteLength || !o(new Me(t), new Me(e))
                );
              case sr:
              case ar:
                return +t == +e;
              ...
              case hr:
                ...
                return l
                  ? l == e
                  : ((r |= ir), s.set(t, e), or(a(t), a(e), o, i, r, s));
              case pr:
        ...
        var Or = function (t, e, n, o, i, s) {
          ...
          if (f && !u)
            return (
              s || (s = new Ot()),
              a || Ar(t) ? or(t, e, n, o, i, s) : vr(t, e, l, n, o, i, s)
            );
          if (!(i & Cr)) {
        ...
        class Mr extends Gi {
          ...
          _onMutations(t) {
            ...
            for (const t of n.values())
              this.renderer.markToSync("text", t.node), i.push(t);
            for (const t of o) {
        ...
        var zr = function (t, e, n) {
          ...
          return (
            ...
            W(n) &&
              ((d = !!n.leading),
              (r = (u = "maxWait" in n) ? Lr(Xn(n.maxWait) || 0, e) : r),
        ...
        class qr extends Gi {
          constructor(t) {
            super(t),
              (this._fireSelectionChangeDoneDebounced = zr(
          ...
          _handleSelectionMove(t) {
            ...
            (t != Xo.arrowleft && t != Xo.arrowup) ||
              n.setTo(n.getFirstPosition()),
              (t != Xo.arrowright && t != Xo.arrowdown) ||
        ...
        class Wr extends Gi {
          ...
          _handleSelectionChange(t) {
            ...
            if (
              ...
              !this.domConverter.isDomSelectionCorrect(e)
            )
              if (++this._loopbackCounter > 60)
                Ur.a.warn(
                  "selectionchange-infinite-loop: Selection change observer detected an infinite rendering loop."
                );
        ...
        class Hr extends Vr {
          constructor(t) {
            ...
            e.on("focus", () => {
              (e.isFocused = !0),
                (this._renderTimeoutId = setTimeout(() => t.render(), 50));
            }),
              e.on("blur", (n, o) => {
                const i = e.selection.editableElement;
                (null !== i && i !== o.target) ||
                  ((e.isFocused = !1), t.render());
              });
          }
          onDomEvent(t) {
            this.fire(t.type, t);
        ...
        class Jr {
          constructor(t) {
            ...
            if (
              ...
              (n.ownerDocument && n.ownerDocument.body.contains(n)) ||
                ...
                Yr(
                  this,
                  e ? Jr.getDomRangeRects(t)[0] : t.getBoundingClientRect()
                );
            } else if (Wi(t)) {
          ...
          getIntersection(t) {
            ...
            return (
              ...
              e.width < 0 || e.height < 0 ? null : new Jr(e)
            );
          }
          ...
          excludeScrollbarsAndBorders() {
            ...
            if (Wi(t))
              ...
              (e = t.offsetWidth - t.clientWidth),
                (n = t.offsetHeight - t.clientHeight),
                this.moveBy(o.left, o.top);
            }
            return (
              (this.width -= e),
              (this.right -= e),
        ...
        function ts(t, e, n) {
          ...
          if (![i, o].every((t) => r.contains(t))) {
            ...
            os(i, r)
              ? (a -= r.top - e.top + n)
              : ns(o, r) && (a += e.bottom - r.bottom + n),
              is(e, r)
                ? (s -= r.left - e.left + n)
                : rs(e, r) && (s += e.right - r.right + n),
              t.scrollTo(s, a);
          }
        }
        function es(t, e) {
            ...
            (i = e()),
              (o = new Jr(t).excludeScrollbarsAndBorders()).contains(i) ||
                (os(i, o)
                  ...
                  : ns(i, o) && (t.scrollTop += i.bottom - o.bottom),
                is(i, o)
                  ? (t.scrollLeft -= o.left - i.left)
                  : rs(i, o) && (t.scrollLeft += i.right - o.right)),
              (t = t.parentNode);
        }
        function ns(t, e) {
        ...
        class ls {
          ...
          focus() {
            if (!this.document.isFocused) {
              ...
              t
                ? (this.domConverter.focus(t), this.render())
                : Ur.a.warn(
          ...
          static fromJSON(t) {
            ...
            if (t.children) {
              ...
              for (const n of t.children)
                n.name ? e.push(ms.fromJSON(n)) : e.push(hs.fromJSON(n));
            }
        ...
        class gs {
          constructor(t = {}) {
            ...
            (this.direction = e),
              (this.boundaries = t.boundaries || null),
              t.startPosition
                ? (this.position = vs.createFromPosition(t.startPosition))
                : (this.position = vs.createFromPosition(
                    this.boundaries[
          ...
          _next() {
            ...
            if (o instanceof hs) {
              ...
              const r = e.offset - o.startOffset,
                s = new fs(o, r, i);
              return (
                (e.offset += i), (this.position = e), bs("text", s, t, e, i)
              );
            }
            return (
              e.path.pop(),
              ...
              this.ignoreElementEnd ? this._next() : bs("elementEnd", n, t, e)
            );
          }
          _previous() {
            const t = this.position,
        ...
        class vs {
          ...
          isTouching(t) {
            ...
            switch (this.compareWith(t)) {
              case "same":
                return !0;
              case "before":
                (e = vs.createFromPosition(this)),
                  (n = vs.createFromPosition(t));
                break;
              case "after":
                (e = vs.createFromPosition(t)),
                  (n = vs.createFromPosition(this));
                break;
              default:
                return !1;
            }
          ...
          _getTransformedByDeletion(t, e) {
            ...
            if ("same" == En(t.getParentPath(), this.getParentPath())) {
              ...
              "prefix" == En(t.getParentPath(), this.getParentPath())
            ) {
          ...
          _getTransformedByInsertion(t, e, n) {
            ...
            if ("same" == En(t.getParentPath(), this.getParentPath()))
              (t.offset < this.offset || (t.offset == this.offset && n)) &&
                (o.offset += e);
          ...
          _getTransformedByMove(t, e, n, o, i) {
            ...
            return (
              ...
              (r =
                null === r || (i && r.isEqual(t))
                  ? this._getCombined(t, e)
                  : r._getTransformedByInsertion(e, n, o))
            );
          }
          _getCombined(t, e) {
            const n = t.path.length - 1,
            ...
            return (
              ...
              (o.path = o.path.concat(this.path.slice(n + 1))),
              o
            );
          }
          static createAt(t, e) {
        ...
        class _s {
          constructor(t, e = null) {
            (this.start = vs.createFromPosition(t)),
              (this.end = e
                ? vs.createFromPosition(e)
                : vs.createFromPosition(t));
          }
          *[Symbol.iterator]() {
          ...
          getDifference(t) {
            ...
            return (
              this.isIntersecting(t)
                ? (this.containsPosition(t.start) &&
                    e.push(new _s(this.start, t.start)),
                  this.containsPosition(t.end) &&
                    e.push(new _s(t.end, this.end)))
                : e.push(_s.createFromRange(this)),
              e
            );
          }
          getIntersection(t) {
          ...
          getMinimalFlatRanges() {
            ...
            for (; n.path.length > e + 1; ) {
              ...
              0 !== e && t.push(new _s(n, n.getShiftedBy(e))),
                (n.path = n.path.slice(0, -1)),
                n.offset++,
                (o = o.parent);
            }
            for (; n.path.length <= this.end.path.length; ) {
              const e = this.end.path[n.path.length - 1],
                o = e - n.offset;
              0 !== o && t.push(new _s(n, n.getShiftedBy(o))),
                (n.offset = e),
                n.path.push(0);
            }
            return t;
          ...
          *getPositions(t = {}) {
            ...
            for (const o of t.operations)
              if (n.has(o.type))
                for (let n = 0; n < e.length; n++) {
                  ...
                  (i =
                    "insert" == o.type
                      ? e[n]._getTransformedByDocumentChange(
                          o.type,
                          t.type,
                          o.position,
                          o.nodes.maxOffset
          ...
          _getTransformedByDocumentChange(t, e, n, o, i) {
            if ("insert" == t)
              return this._getTransformedByInsertion(n, o, !1, !1);
            {
              const t = _s.createFromPositionAndShift(i, o);
              if (
                "merge" == e &&
                this.isCollapsed &&
                (this.start.isEqual(t.start) || this.start.isEqual(t.end))
              ) {
                const e = this.start.offset - t.start.offset;
                return [new _s(n.getShiftedBy(e))];
              }
              if ("split" == e && this.isCollapsed && this.end.isEqual(t.end))
                return [new _s(n.getShiftedBy(o))];
              if (
                (t.containsPosition(this.start) ||
                  t.start.isEqual(this.start)) &&
                this.containsPosition(t.end) &&
                this.end.isAfter(n)
              ) {
                const t = this.start._getCombined(
                    i,
                    n._getTransformedByDeletion(i, o)
                  ),
                  e = this.end._getTransformedByMove(i, n, o, !1, !1);
                return [new _s(t, e)];
              }
              if (
                (t.containsPosition(this.end) || t.end.isEqual(this.end)) &&
                this.containsPosition(t.start) &&
                this.start.isBefore(n)
              ) {
                const t = this.start._getTransformedByMove(i, n, o, !0, !1),
                  e = this.end._getCombined(
                    i,
                    n._getTransformedByDeletion(i, o)
                  );
                return [new _s(t, e)];
          ...
          _getTransformedByInsertion(t, e, n = !1, o = !1) {
            if (n && this.containsPosition(t))
              return [
                new _s(this.start, t),
                new _s(
                  t._getTransformedByInsertion(t, e, !0),
                  this.end._getTransformedByInsertion(t, e, this.isCollapsed)
                ),
              ];
            {
              const n = _s.createFromRange(this),
                ...
                r = !!n.isCollapsed || o;
              return (
                (n.start = n.start._getTransformedByInsertion(t, e, i)),
                (n.end = n.end._getTransformedByInsertion(t, e, r)),
                [n]
              );
            }
          }
          _getTransformedByMove(t, e, n) {
            ...
            1 == r.length
              ? (s = new _s(
                  r[0].start._getTransformedByDeletion(t, n),
                  r[0].end._getTransformedByDeletion(t, n)
                ))
              : 2 == r.length &&
                (s = new _s(
                  this.start,
            ...
            return (
              (o = s ? s._getTransformedByInsertion(c, n, null !== a) : []),
              a &&
                o.push(
                  new _s(
                    a.start._getCombined(i.start, c),
                    a.end._getCombined(i.start, c)
                  )
                ),
              o
            );
          ...
          static createFromParentsAndOffsets(t, e, n, o) {
            return new this(
              vs.createFromParentAndOffset(t, e),
              vs.createFromParentAndOffset(n, o)
            );
          }
          static createFromRange(t) {
            return new this(t.start, t.end);
          ...
          static createOn(t) {
            return this.createFromPositionAndShift(
              vs.createBefore(t),
              t.offsetSize
            );
          }
          ...
          static createFromRanges(t) {
            ...
            for (let e = n - 1; e >= 0 && t[e].end.isEqual(o.start); e++)
              o.start = vs.createFromPosition(t[e].start);
            for (let e = n + 1; e < t.length && t[e].start.isEqual(o.end); e++)
              o.end = vs.createFromPosition(t[e].end);
            return o;
          }
          static fromJSON(t, e) {
        ...
        class ks {
            ...
            (this._modelToViewMapping = new WeakMap()),
              ...
              this.on(
                ...
                (t, e) => {
                  ...
                  e.viewPosition = this._findPositionIn(
                    n,
              ...
              this.on(
                ...
                (t, e) => {
                  ...
                  for (; !o; )
                    (n = n.parent), (o = this._viewToModelMapping.get(n));
          ...
          _findPositionIn(t, e) {
            ...
            for (; i < e; )
              (n = t.getChild(r)), (i += o = this.getModelLength(n)), r++;
            return i == e
              ? this._moveViewPositionToTextNode(new Fo(t, r))
              : this._findPositionIn(n, e - (i - o));
          }
          _moveViewPositionToTextNode(t) {
            const e = t.nodeBefore,
              n = t.nodeAfter;
            return e instanceof On
              ? new Fo(e, e.data.length)
              : n instanceof On
              ? new Fo(n, 0)
              : t;
          }
          ...
          _addSymbolForTextProxy(t, e, n) {
            ...
            return (
              (i = this._textProxyRegistry.get(t)) ||
                ((i = new Map()), this._textProxyRegistry.set(t, i)),
              (r = i.get(e)) || ((r = new Map()), i.set(e, r)),
              r.set(n, o),
              o
            );
          }
        ...
        class As {
          ...
          convertChanges(t, e) {
            for (const n of t.getMarkersToRemove())
              this.convertMarkerRemove(n.name, n.range, e);
            for (const n of t.getChanges())
              "insert" == n.type
                ? this.convertInsert(
                    _s.createFromPositionAndShift(n.position, n.length),
                    e
                  )
                : "remove" == n.type
            ...
            for (const n of t.getMarkersToAdd())
          ...
          convertInsert(t, e) {
            ...
            for (const e of t) {
              const t = e.item,
                n = {
                  item: t,
                  range: _s.createFromPositionAndShift(
                    e.previousPosition,
                    e.length
                  ),
                };
          ...
          convertSelection(t, e, n) {
            ...
            if (
              ...
              for (const e of o) {
                const n = e.getRange();
                if (!Cs(t.getFirstPosition(), e, this.conversionApi.mapper))
                  continue;
          ...
          *getRanges() {
          ...
          setTo(t, e, n) {
            if (null === t) this._setRanges([]);
              ...
              if (!Mn(t))
                throw new m.b(
                  "model-selection-setTo-not-selectable: Cannot set selection to given place."
                );
          ...
          _setRanges(t, e = !1) {
            const n = (t = Array.from(t)).some((t) => {
              if (!(t instanceof _s))
                throw new m.b(
                  "model-selection-added-not-range: Trying to add an object that is not an instance of Range."
                );
          ...
          setFocus(t, e) {
            ...
            this._ranges.length && this._popRange(),
              "before" == n.compareWith(o)
                ? (this._pushRange(new _s(n, o)),
                  (this._lastRangeBackward = !0))
                : (this._pushRange(new _s(o, n)),
                  (this._lastRangeBackward = !1)),
              this.fire("change:range", { directChange: !0 });
          }
          getAttribute(t) {
          ...
          *getSelectedBlocks() {
            ...
            for (const e of this.getRanges()) {
              ...
              for (const n of e.getWalker())
                "elementEnd" == n.type && Ss(n.item, t) && (yield n.item);
              const o = Es(e.end, t);
        ...
        function Ss(t, e) {
          return (
            !e.has(t) &&
            (e.add(t), t.document.model.schema.isBlock(t) && t.parent)
          );
        }
        function Es(t, e) {
                  ...
                  (e, n) => {
                    ...
                    o.isDocumentOperation &&
                      ...
                      function (t) {
                        ...
                        let o, i;
                        "insert" == e
                          ? (o = _s.createFromPositionAndShift(
                              t.position,
                              t.nodes.maxOffset
                            ))
                          : ((o = _s.createFromPositionAndShift(
                        ...
                        let s = o.start;
                        ("move" != e && "remove" != e && "reinsert" != e) ||
                          (s = s._getTransformedByInsertion(i, r));
                        const a = this._getTransformedByDocumentChange(
                          e,
                          t.delta.type,
                          s,
                          r,
                        ...
                        const c = _s.createFromRanges(a),
                          ...
                          u =
                            i &&
                            (this.containsPosition(i) || this.start.isEqual(i)),
                          h = d || u;
                        if (l) {
                          ...
                          h &&
                            this.fire(
                              "change:content",
                              _s.createFromRange(this),
                              { type: e, batch: n, range: o, sourcePosition: i }
                            );
                      }.call(this, o);
                  },
                  { priority: "low" }
              ...
              this.listenTo(
                ...
                () => {
                  for (; this._fixGraveyardRangesData.length; ) {
                    const { liveRange: t, sourcePosition: e } =
          ...
          *getRanges() {
          ...
          restoreGravity(t) {
            ...
            this._overriddenGravityRegister.delete(t),
              this.isGravityOverridden || this._refreshAttributes();
          }
          _refreshAttributes() {
          ...
          _prepareRange(t) {
            if ((this._checkRange(t), t.root == this._document.graveyard))
              return void Ur.a.warn(
                "model-selection-range-in-graveyard: Trying to add a Range that is in the graveyard root. Range rejected."
              );
          ...
          *_getStoredAttributes() {
          ...
          _getSurroundingAttributes() {
            ...
            if (this.isCollapsed) {
              ...
              if (
                (this.isGravityOverridden || (n = Ms(e)),
                n || (n = Ms(o)),
        ...
        function Ns(t) {
          let e =
            "attribute:" + ((t = Fs(t)).model.key ? t.model.key : t.model);
          if ((t.model.name && (e += ":" + t.model.name), t.model.values))
            for (const e of t.model.values)
              t.view[e] = Bs(t.view[e], "attribute");
            ...
            o.on(
              ...
              (function (t) {
                return (e, n, o) => {
                  ...
                  if (n.item instanceof Ts || n.item instanceof Rs)
        ...
        function Ds(t) {
          let e =
            "attribute:" + ((t = Fs(t)).model.key ? t.model.key : t.model);
          if ((t.model.name && (e += ":" + t.model.name), t.model.values))
            for (const e of t.model.values) t.view[e] = js(t.view[e]);
        ...
        class zs {
          constructor(t) {
            ...
            this.listenTo(
              ...
              () => {
                this.view.change((t) => {
                  this.downcastDispatcher.convertChanges(e.differ, t),
              ...
              this.downcastDispatcher.on(
                ...
                (t, e, n) => {
                  ...
                  for (const t of Vo.createIn(a).getItems())
        ...
        class qs {
          constructor(t, e = []) {
            ...
            for (const t of e)
              this._availablePlugins.set(t, t),
          ...
          *[Symbol.iterator]() {
          ...
          load(t, e = []) {
            ...
            if (c) {
              ...
              return (
                Ur.a.error(t, { plugins: c }),
                Promise.reject(new m.b(t, { plugins: c }))
              );
            }
        ...
        function Ws(t, e) {
          ...
          return (
            ...
            (function (t, e) {
              return (
                t in window.CKEDITOR_TRANSLATIONS &&
                e in window.CKEDITOR_TRANSLATIONS[t]
              );
            })(t, e)
              ? window.CKEDITOR_TRANSLATIONS[t][e].replace(
                  / \[context: [^\]]+\]$/,
                  ""
                )
              : e.replace(/ \[context: [^\]]+\]$/, "")
        ...
        class $s {
          ...
          add(t, e) {
            ...
            t.is("text") || t.is("documentFragment")
              ...
              : (this._consumables.has(t)
                  ...
                  : ((n = new Ks()), this._consumables.set(t, n)),
                n.add(e));
          }
          test(t, e) {
          ...
          static createFrom(t, e) {
            ...
            t.is("element") && e.add(t, $s.consumablesFromElement(t)),
        ...
        class Gs {
          ...
          getLimitElement(t) {
            ...
            if (t instanceof vs) e = t.parent;
              ...
              e = (t instanceof _s ? [t] : Array.from(t.getRanges())).reduce(
                (t, e) => {
          ...
          checkAttributeInSelection(t, e) {
            if (t.isCollapsed)
              return this.checkAttribute(
                [...t.getFirstPosition().getAncestors(), "$text"],
                e
              );
            {
              const n = t.getRanges();
          ...
          getValidRanges(t, e) {
            ...
            for (const o of t) {
              ...
              for (const r of o.getWalker())
                this.checkAttribute(r.item, e) ||
                  (i.isEqual(t) || n.push(new _s(i, t)), (i = r.nextPosition)),
                  (t = r.nextPosition);
          ...
          getNearestSelectionRange(t, e = "both") {
            ...
            let n, o;
            ("both" != e && "backward" != e) ||
              (n = new gs({ startPosition: t, direction: "backward" })),
              ("both" != e && "forward" != e) ||
                (o = new gs({ startPosition: t }));
            for (const t of (function* (t, e) {
              ...
              if (o.type == e && this.isObject(o.item))
                return _s.createOn(o.item);
              if (this.checkChild(o.nextPosition, "$text"))
                return new _s(o.nextPosition);
            }
            return null;
          }
          ...
          removeDisallowedAttributes(t, e) {
            for (const n of t) {
              ...
              n.is("element") &&
                this.removeDisallowedAttributes(n.getChildren(), e);
            }
          }
          _clearCache() {
        ...
        class Js {
          constructor(t) {
            ...
            "string" == typeof t
              ...
              t[0] &&
                "string" != typeof t[0] &&
                t[0].is("documentFragment") &&
                t.shift(),
              (this._items = t.map(ra));
          }
          get length() {
            return this._items.length;
          }
        ...
        function oa(t, e, n) {
          for (const o of t)
            "string" == typeof o[n]
              ? e[n].push(o[n])
              : Array.isArray(o[n]) && e[n].push(...o[n]);
        }
        function ia(t, e) {
          const n = t[e];
          return (function (t) {
        ...
        class sa {
              ...
              i.markers = (function (t, e) {
                ...
                for (const t of n) {
                  const n = t.getAttribute("data-name"),
                    i = vs.createBefore(t);
                  o.has(n)
                    ? (o.get(n).end = vs.createFromPosition(i))
                    : o.set(n, new _s(vs.createFromPosition(i))),
                    e.remove(t);
                }
                return o;
              })(i, e);
          ...
          _convertChildren(t, e) {
            ...
            for (const e of Array.from(t.getChildren())) {
              ...
              t.modelRange instanceof _s &&
                ((n.end = t.modelRange.end), (o = t.modelCursor));
            }
          ...
          _splitToAllowedParent(t, e) {
            ...
            for (const t of o.range.getPositions())
              t.isEqual(o.position) || this._removeIfEmpty.add(t.parent);
            return { position: o.position, cursorParent: o.range.end.parent };
          }
          _removeEmptyElements() {
            let t = !1;
            for (const e of this._removeIfEmpty)
              e.isEmpty &&
                (this.conversionApi.writer.remove(e),
                this._removeIfEmpty.delete(e),
                (t = !0));
          ...
          const e = (function (t) {
              ...
              return (n, o, i) => {
                ...
                i.consumable.consume(o.viewItem, r.match),
                  (o.modelRange = new _s(
                    vs.createBefore(s),
                    vs.createAfter(c.modelCursor.parent)
                  )),
                  a.cursorParent
                    ? (o.modelCursor = vs.createAt(a.cursorParent))
            ...
            null !== c &&
              ...
              r.consumable.test(i.viewItem, s.match) &&
                (i.modelRange ||
                  (i = Object.assign(
                    i,
                    r.convertChildren(i.viewItem, i.modelCursor)
                  )),
                (function (t, e, n, o) {
                  let i = !1;
                  for (const r of Array.from(t.getItems({ shallow: n })))
                    o.schema.checkAttribute(r, e.key) &&
                      (o.writer.setAttribute(e.key, e.value, r), (i = !0));
                  return i;
        ...
        class fa {
          ...
          toView(t) {
            ...
            if (
              ...
              this.downcastDispatcher.convertInsert(e, o),
        ...
        class pa {
          ...
          register(t, e) {
            if (this._dispatchersGroups.has(t))
              throw new m.b(
                "conversion-register-group-exists: Trying to register a group name that was already registered."
              );
          ...
          elementToElement(t) {
            ...
            for (const { model: e, view: n } of ma(t))
              this.for("upcast").add(
                aa({
                  model: e,
                  view: n,
          ...
          attributeToElement(t) {
            ...
            for (const { model: e, view: n } of ma(t))
              this.for("upcast").add(
                ca({ view: n, model: e, priority: t.priority })
              );
          }
          attributeToAttribute(t) {
            this.for("downcast").add(Ds(t));
            for (const { model: e, view: n } of ma(t))
              this.for("upcast").add(la({ view: n, model: e }));
          }
          _getDispatchers(t) {
        ...
        function* ma(t) {
          if (t.model.values)
            for (const e of t.model.values) {
              yield* ga(
                { key: t.model.key, value: e },
                t.view[e],
                t.upcastAlso ? t.upcastAlso[e] : void 0
              );
            }
        ...
        function ka(t) {
          ...
          for (let n = 0; n < t.length; n++)
            ...
            else if (t[n] instanceof fs)
              e.push(new hs(t[n].data, t[n].getAttributes()));
            else if (t[n] instanceof wa || t[n] instanceof ps)
          ...
          for (let t = 1; t < e.length; t++) {
            ...
            n instanceof hs &&
              o instanceof hs &&
              Aa(n, o) &&
              (e.splice(t - 1, 2, new hs(o.data + n.data, o.getAttributes())),
              t--);
          }
          return e;
        }
        ...
        class Ta extends ba {
          constructor(t, e, n, o, i) {
            super(i),
              (this.range = _s.createFromRange(t)),
              (this.key = e),
          ...
          _validate() {
            for (const t of this.range.getItems()) {
              if (
                null !== this.oldValue &&
                !Ca(t.getAttribute(this.key), this.oldValue)
              )
                throw new m.b(
        ...
        class Sa extends ba {
          constructor(t, e, n, o) {
            super(o),
              (this.sourcePosition = vs.createFromPosition(t)),
              (this.howMany = e),
              (this.targetPosition = vs.createFromPosition(n)),
              (this.isSticky = !1);
          }
          get type() {
            return "move";
          ...
          _execute() {
            !(function (t, e) {
              ...
              _s.createFromPositionAndShift(this.sourcePosition, this.howMany),
              this.targetPosition
            );
          }
          static get className() {
        ...
        class Ea extends Sa {
          ...
          _validate() {
            if ((super._validate(), !this.sourcePosition.root.document))
              throw new m.b(
                "reinsert-operation-on-detached-item: Cannot reinsert detached item."
              );
            if (!this.targetPosition.root.document)
              throw new m.b(
                "reinsert-operation-to-detached-parent: Cannot reinsert item to detached parent."
              );
          }
          static get className() {
        ...
        class Pa extends Sa {
          ...
          _validate() {
            if ((super._validate(), !this.sourcePosition.root.document))
              throw new m.b(
                "remove-operation-on-detached-item: Cannot remove detached item."
              );
          }
          static get className() {
        ...
        class Oa extends ba {
          constructor(t, e, n) {
            super(n),
              (this.position = vs.createFromPosition(t)),
              (this.nodes = new ps(ka(e)));
          }
          get type() {
            return "insert";
          }
          ...
          _execute() {
            const t = this.nodes;
            (this.nodes = new ps([...t].map((t) => t._clone(!0)))),
              va(this.position, t);
          }
          static get className() {
          ...
          static fromJSON(t, e) {
            ...
            for (const e of t.nodes)
              e.name ? n.push(ms.fromJSON(e)) : n.push(hs.fromJSON(e));
        ...
        class Ra extends ba {
          constructor(t, e, n, o, i, r) {
            super(i),
              (this.name = t),
              (this.oldRange = e ? _s.createFromRange(e) : null),
              (this.newRange = n ? _s.createFromRange(n) : null),
              (this.affectsData = r),
              (this._markers = o);
          }
          get type() {
          ...
          static fromJSON(t, e) {
            return new Ra(
              t.name,
              t.oldRange ? _s.fromJSON(t.oldRange, e) : null,
              t.newRange ? _s.fromJSON(t.newRange, e) : null,
              e.model.markers,
              t.baseVersion,
              t.affectsData
            );
        ...
        class Ma extends ba {
          ...
          clone() {
            return new Ma(
              vs.createFromPosition(this.position),
              this.oldName,
              this.newName,
              this.baseVersion
            );
        ...
        class Ba {
          static fromJSON(t, e) {
            ...
            for (const e in t)
              "__className" != e && void 0 === n[e] && (n[e] = t[e]);
            return n;
          }
          static register(t) {
        ...
        class La {
          ...
          getReversed() {
            ...
            for (let e = 0; e < t.operations.length; e++)
              t.operations[e].baseVersion =
                this.operations[this.operations.length - 1].baseVersion + e + 1;
            return t;
          }
          toJSON() {
            const t = Sn(this);
            return (
              (t.__className = this.constructor.className), delete t.batch, t
            );
          }
          static get className() {
        ...
        class ja extends La {
          ...
          get range() {
            ...
            for (const n of this.operations)
              n instanceof Ia ||
                ((null === t || t.isAfter(n.range.start)) &&
                  (t = n.range.start),
                (null === e || e.isBefore(n.range.end)) && (e = n.range.end));
        ...
        class za extends La {
          ...
          get position() {
            return this._moveOperation
              ? this._moveOperation.sourcePosition
              : null;
          }
          get _cloneOperation() {
          ...
          get _moveOperation() {
            return this.operations[1] && this.operations[1] instanceof Sa
              ? this.operations[1]
              : null;
          }
          get _reverseDeltaClass() {
        ...
        class qa extends La {
          ...
          get position() {
            return this._removeOperation
              ? this._removeOperation.sourcePosition
              : null;
          }
        ...
        class Ua extends La {
          ...
          get targetPosition() {
            return this._moveOperation
              ? this._moveOperation.targetPosition
              : null;
          }
          get _moveOperation() {
            return this.operations[0] || null;
        ...
        class $a extends La {
          ...
          get range() {
            ...
            return t
              ? _s.createFromPositionAndShift(t.sourcePosition, t.howMany)
              : null;
          }
          get howMany() {
            const t = this.range;
        ...
        const Ya = {
          InsertOperation: {
            InsertOperation(t, e, n) {
              ...
              return (
                (o.position = o.position._getTransformedByInsertion(
                  e.position,
                  e.nodes.maxOffset,
                  i
                )),
            ...
            MoveOperation(t, e, n) {
              const o = t.clone(),
                i = void 0 === n.insertBefore ? !n.isStrong : n.insertBefore;
              return (
                (o.position = t.position._getTransformedByMove(
                  e.sourcePosition,
                  e.targetPosition,
                  e.howMany,
                  i,
                  e.isSticky && !n.forceNotSticky
                )),
                [o]
              );
            },
          ...
          AttributeOperation: {
            InsertOperation: (t, e) =>
              t.range
                ...
                .reverse()
                .map(
                  (e) => new Ta(e, t.key, t.oldValue, t.newValue, t.baseVersion)
                ),
            AttributeOperation(t, e, n) {
              if (t.key === e.key) {
                const o = t.range
                    ...
                    .map(
                      (e) =>
                        new Ta(e, t.key, t.oldValue, t.newValue, t.baseVersion)
                    ),
            ...
            MarkerOperation: Xa,
            MoveOperation(t, e) {
              const n = _s.createFromPositionAndShift(
                e.sourcePosition,
                e.howMany
              );
              let o = [];
              const i = (function (t) {
                  return 0 === t.length
                    ...
                    : 1 == t.length
                    ? t[0]
                    : ((t[0].end = t[t.length - 1].end), t[0]);
                })(t.range.getDifference(n)),
                r = t.range.getIntersection(n);
              return (
                null !== i &&
                  ((i.start = i.start._getTransformedByDeletion(
                    e.sourcePosition,
                    e.howMany
                  )),
                  (i.end = i.end._getTransformedByDeletion(
                    e.sourcePosition,
                    e.howMany
                  )),
                  (o = i
                    ...
                    .reverse())),
                null !== r &&
                  ((r.start = r.start._getCombined(
                    e.sourcePosition,
                    e.getMovedRangeStart()
                  )),
                  (r.end = r.end._getCombined(
                    e.sourcePosition,
                    e.getMovedRangeStart()
                  )),
                  o.push(r)),
          ...
          RootAttributeOperation: {
            InsertOperation: Xa,
            AttributeOperation: Xa,
            RootAttributeOperation: (t, e, n) =>
              t.root !== e.root ||
              t.key !== e.key ||
              ((t.newValue === e.newValue || n.isStrong) &&
                t.newValue !== e.newValue)
                ? [t.clone()]
                : [new Ia(t.baseVersion)],
            RenameOperation: Xa,
            MarkerOperation: Xa,
            MoveOperation: Xa,
          },
          RenameOperation: {
            InsertOperation(t, e) {
              const n = t.clone();
              return (
                (n.position = n.position._getTransformedByInsertion(
                  e.position,
                  e.nodes.maxOffset,
                  !0
                )),
            ...
            MoveOperation(t, e) {
              ...
              return (
                (n.position = n.position._getTransformedByMove(
                  e.sourcePosition,
                  e.targetPosition,
                  e.howMany,
                  !0,
          ...
          MarkerOperation: {
            InsertOperation(t, e) {
              ...
              return (
                n.oldRange &&
                  (n.oldRange = n.oldRange._getTransformedByInsertion(
                    e.position,
                    e.nodes.maxOffset,
                    !1,
                    !1
                ...
                n.newRange &&
                  (n.newRange = n.newRange._getTransformedByInsertion(
                    e.position,
                    e.nodes.maxOffset,
                    !1,
                    !1
            ...
            MoveOperation(t, e) {
              const n = t.clone();
              if (n.oldRange) {
                const t = n.oldRange._getTransformedByMove(
                  e.sourcePosition,
                  e.targetPosition,
                  e.howMany
                );
              ...
              if (n.newRange) {
                const t = n.newRange._getTransformedByMove(
                  e.sourcePosition,
                  e.targetPosition,
                  e.howMany
                );
          ...
          MoveOperation: {
            InsertOperation(t, e, n) {
              let o = _s.createFromPositionAndShift(
                t.sourcePosition,
                t.howMany
              );
              const i = t.isSticky && !n.forceNotSticky;
              o = o._getTransformedByInsertion(
                e.position,
                e.nodes.maxOffset,
                !1,
                i
              ...
              const r =
                  void 0 === n.insertBefore ? !n.isStrong : n.insertBefore,
                s = new t.constructor(
                  o.start,
                  o.end.offset - o.start.offset,
                  t.targetPosition._getTransformedByInsertion(
                    e.position,
                    e.nodes.maxOffset,
                    r
                  ),
            ...
            MarkerOperation: Xa,
            MoveOperation(t, e, n) {
              const o = _s.createFromPositionAndShift(
                  t.sourcePosition,
                  t.howMany
                ),
              ...
              const s = t.isSticky && !n.forceNotSticky,
                ...
                c = t.targetPosition._getTransformedByMove(
                  e.sourcePosition,
                  e.targetPosition,
                  e.howMany,
                  a,
              ...
              const l =
                ...
                (o.start.isEqual(e.targetPosition) && s) ||
                (o.end.isEqual(e.targetPosition) && s);
              ...
              if (
                (i.containsPosition(t.targetPosition) ||
                  (i.start.isEqual(t.targetPosition) &&
                    e.isSticky &&
                    !n.forceNotSticky) ||
                  (i.end.isEqual(t.targetPosition) &&
                    e.isSticky &&
                    !n.forceNotSticky)) &&
                i.containsRange(o, !0)
              )
              ...
              n.forceWeakRemove ||
                (t instanceof Pa && !(e instanceof Pa)
                  ? (r = !0)
                  : !(t instanceof Pa) && e instanceof Pa && (r = !1));
              const u = [],
                h = o.getDifference(i);
              for (const t of h) {
        ...
        function ec(t, e, n) {
          ...
          const i = new (o =
            "$graveyard" == e.root.rootName
              ...
              ? Ea
              : Sa)(t.start, t.end.offset - t.start.offset, e, 0);
        ...
        var rc = function (t, e, n) {
          ...
          var o = t ? t.length : 0;
          if (!o || e < 1) return [];
          for (var i = 0, r = 0, s = Array(oc(o / e)); i < o; )
            s[r++] = nc(t, i, (i += e));
          return s;
        };
        var sc = function (t) {
        ...
        var pc = function (t, e) {
          for (var n = -1, o = t.length, i = Array(o); ++n < o; )
            i[n] = e(t[n], n, t);
          return i;
        };
        var mc = function (t) {
        ...
        var wc = function (t, e, n, o) {
            ...
            n && (e = pc(e, mc(n))),
              o
                ? ((r = fc), (s = !1))
                : e.length >= bc && ((r = gc), (s = !1), (e = new Zi(e)));
            t: for (; ++i < a; ) {
              var d = t[i],
                u = n ? n(d) : d;
        ...
        var Jc = function (t, e) {
          for (
            var n = 0, o = (e = $c(e, t) ? [e] : Uc(e)).length;
            null != t && n < o;
        ...
        var Xc = function (t, e, n) {
          for (
            var o, i = -1, r = (e = $c(e, t) ? [e] : Uc(e)).length;
            ++i < r;
        ...
        var sl = function (t) {
          ...
          al = ro(function (t, e) {
            var n = ws(e);
            return (
              Ht(n) && (n = void 0), Ht(t) ? wc(t, cc(e, 1, Ht, !0), sl(n)) : []
            );
          }),
          cl = ro(function (t, e) {
            var n = ws(e);
            return (
              Ht(n) && (n = void 0),
              Ht(t) ? wc(t, cc(e, 1, Ht, !0), void 0, n) : []
            );
          });
        var ll = function (t, e, n) {
          var o = t ? t.length : 0;
          return o
            ? ((e = n || void 0 === e ? 1 : no(e)), nc(t, e < 0 ? 0 : e, o))
            : [];
        };
        ...
        var bl = function (t, e, n, o) {
          var i = t.length;
          for (
            (n = no(n)) < 0 && (n = -n > i ? 0 : i + n),
              (o = void 0 === o || o > i ? i : no(o)) < 0 && (o += i),
              o = n > o ? 0 : gl(o);
            n < o;
        ...
        var wl = function (t, e, n, o) {
          var i = t ? t.length : 0;
          return i
            ? (n && "number" != typeof n && zn(t, e, n) && ((n = 0), (o = i)),
              bl(t, e, n, o))
            : [];
        };
        var vl = function (t, e, n) {
          for (var o = t.length, i = n ? o : -1; n ? i-- : ++i < o; )
        ...
        var Ml = function (t) {
          ...
          Vl = ro(function (t) {
            var e = ws(t),
              n = pc(t, Ml);
            return (
              e === ws(n) ? (e = void 0) : n.pop(),
              n.length && n[0] === t[0] ? Il(n, sl(e)) : []
            );
          }),
          Nl = ro(function (t) {
            var e = ws(t),
            ...
            return (
              e === ws(n) ? (e = void 0) : n.pop(),
              n.length && n[0] === t[0] ? Il(n, void 0, e) : []
            );
          }),
        ...
        var zl = function (t, e, n) {
          ...
          if (
            (void 0 !== n &&
              (i = ((i = no(n)) < 0 ? Ll(o + i, 0) : jl(i, o - 1)) + 1),
            e != e)
          )
            return dc(t, i, !0);
        ...
        var $l = function (t, e, n, o) {
          var i = o ? Wl : uc,
            ...
            s = e.length,
            a = t;
          for (n && (a = pc(t, mc(n))); ++r < s; )
            for (
              var c = 0, l = e[r], d = n ? n(l) : l;
              (c = i(a, d, c, o)) > -1;

            )
              a !== t && Hl.call(a, c, 1), Hl.call(t, c, 1);
          return t;
        };
        var Kl = function (t, e) {
        ...
        var Yl = function (t, e) {
          for (var n = -1, o = null == t, i = e.length, r = Array(i); ++n < i; )
            r[n] = o ? void 0 : Qc(t, e[n]);
          return r;
        };
        var Xl = function (t, e) {
        ...
        var xd = function (t, e, n) {
          return t && t.length
            ? ((e = n || void 0 === e ? 1 : no(e)), nc(t, 0, e < 0 ? 0 : e))
            : [];
        };
        ...
        var qd = function (t, e, n) {
            for (var o = -1, i = t.length; ++o < i; )
              var r = r ? ge(wc(r, t[o], e, n), wc(t[o], r, e, n)) : t[o];
        ...
        var Qd = function (t, e) {
          ...
          Yd = ro(function (t) {
            var e = t.length,
              n = e > 1 ? t[e - 1] : void 0;
            return (
              (n = "function" == typeof n ? (t.pop(), n) : void 0), jd(t, n)
            );
          }),
          Xd = {
            chunk: rc,
        ...
        const Zd = new Map(),
          tu = {
            transform(t, e, n) {
              const o = (tu.getTransformationCase(t, e) || tu.defaultTransform)(
                t,
                e,
                Object.assign({}, n)
              );
              return (function (t, e) {
                for (const n of e)
                  for (const e of n.operations) e.baseVersion = ++t;
                return e;
              ...
              for (const e of t.operations) {
                ...
                for (const e of i)
                  for (let o = 0; o < t.length; o++) {
                    const i = t[o],
                      s = Qa(i, e, n);
                    Array.prototype.splice.apply(t, [o, 1].concat(s)),
                      (o += s.length - 1);
                    const a = Object.assign({}, n);
                    (a.isStrong = !n.isStrong),
                      (a.insertBefore =
                        void 0 !== n.insertBefore ? !n.insertBefore : void 0);
                    const c = Qa(e, i, a);
              ...
              return (function t(e, n) {
                ...
                switch (e) {
                    ...
                    for (const t of n)
                      (i =
                        t instanceof Ia
                          ...
                          : t instanceof Pa
                          ? new Wa()
                          : new Ua()).addOperation(t),
                        o.push(i);
                    return o;
                  case za:
                  case $a:
                    return (
                      (i = new e()).addOperation(n[0]),
                      i.addOperation(n[1]),
                      (o = t(Ua, n.slice(2))),
                      [i].concat(o)
                    );
                  ...
                  case Ka:
                    return (
                      (o = t(Ua, n.slice(0, -2))),
                      (i = new e()).addOperation(n[n.length - 2]),
                      i.addOperation(n[n.length - 1]),
                      o.concat(i)
                    );
                  case Ha:
                    return (
                      (i =
                        n[0] instanceof Ia ? new La() : new Ha()).addOperation(
                        n[0]
                      ),
                      [i]
                    );
            ...
            transformDeltaSets(t, e, n = null) {
              const o = Array.from(t),
                ...
                s = { isStrong: !0 };
              if (r) {
                (s.wasAffected = new Map()),
                  (s.originalDelta = new Map()),
                  (s.document = n),
                  (s.undoMode = !0);
        ...
        function su(t, e, n) {
          delete n.insertBefore,
            delete n.forceNotSticky,
            delete n.forceWeakRemove;
        ...
        function du(t, e) {
          const n = t.clone(),
            o = n.operations[0];
          return (
            o.oldRange && (o.oldRange = o.oldRange.getTransformedByDelta(e)[0]),
            o.newRange && (o.newRange = o.newRange.getTransformedByDelta(e)[0]),
            [n]
          );
        }
        function uu(t, e) {
          ...
          for (let t = 1; t < o.length; t++) {
            ...
            c != i && (i != e.value && a(), (i = c), (r = s)),
              (s += n.offsetSize);
          }
          return a(), n;
          function a() {
            const o = new _s(
                t.position.getShiftedBy(r),
                t.position.getShiftedBy(s)
              ),
        ...
        cu(ja, Ja, (t, e, n) => {
          ...
          cu(ja, za, (t, e, n) => {
            ...
            for (const n of t.operations)
              if (n.range.containsPosition(i) || n.range.start.isEqual(i)) {
                ...
                s.path.push(0);
                const a = e._cloneOperation.nodes
                  .getNode(0)
                  .getAttribute(n.key);
                t.addOperation(
                  new Ta(
          ...
          cu(Ga, qa, (t, e, n) => {
            if (!e.position) return lu(t, e, n);
            return !n.undoMode && t.position.isEqual(e.position)
              ? [e.getReversed(), t.clone()]
              : lu(t, e, n);
          }),
          cu(au, za, du),
          cu(au, qa, du),
          ...
          cu(Ua, qa, (t, e, n) => {
            ...
            const o =
                t.sourcePosition.root == e.position.root &&
                "same" ===
                  En(
                    t.sourcePosition.getParentPath(),
                    e.position.getParentPath()
                  ),
              i =
                t.sourcePosition.offset <= e.position.offset &&
                t.sourcePosition.offset + t.howMany > e.position.offset;
          ...
          cu(qa, Ua, (t, e, n) => {
            ...
            const o =
                t.position.root == e.sourcePosition.root &&
                "same" ===
                  En(
                    t.position.getParentPath(),
                    e.sourcePosition.getParentPath()
                  ),
              i =
                e.sourcePosition.offset <= t.position.offset &&
                e.sourcePosition.offset + e.howMany > t.position.offset;
          ...
          cu(za, za, (t, e, n) => {
            ...
            if (t.position.root == e.position.root && "same" == En(o, i)) {
              if (
                (t = t.clone()).position.offset < e.position.offset ||
                (t.position.offset == e.position.offset && n.isStrong)
              ) {
                t._cloneOperation instanceof Ea &&
                  e._cloneOperation instanceof Ea &&
                  t._cloneOperation.sourcePosition.offset >
                    e._cloneOperation.sourcePosition.offset &&
                  t._cloneOperation.sourcePosition.offset--;
                const n = _s.createFromPositionAndShift(
                    t.position,
                    t._moveOperation.howMany
                  ),
                  o = _s.createFromPositionAndShift(
                    e.position,
                    e._moveOperation.howMany
                  ),
                  i = n.getDifference(o);
                let r = 0;
                ...
                return (
                  0 === r
                    ? (t.operations.pop(),
                      t.addOperation(new Ia(t.operations[0].baseVersion + 1)))
                    : (t.operations[1].howMany = r),
                  [t]
                );
              }
              {
          ...
          cu(za, Ka, (t, e, n) =>
            ...
            "same" === En(e.position.path, t.position.getParentPath())
              ? [hu()]
              : lu(t, e, n)
          ),
          cu(za, $a, (t, e, n) => {
            ...
            const o = t.position.root == e.range.start.root,
              i =
                o &&
                "same" ===
                  En(t.position.getParentPath(), e.range.start.getParentPath()),
              r =
                e.range.start.offset < t.position.offset &&
                e.range.end.offset >= t.position.offset;
            if (i && r) return [hu()];
            if (
              o &&
              "same" ===
                En(
                  t.position.getParentPath(),
                  e.range.end.getShiftedBy(-1).path
                )
            ) {
              const n = t.clone(),
              ...
              r.path.push(t.position.offset),
                (n._moveOperation.sourcePosition = r);
          ...
          cu(za, ja, (t, e, n) => {
            ...
            for (const n of e.operations)
              if (n.range.containsPosition(i) || n.range.start.isEqual(i)) {
                null !== n.newValue
                  ? t._cloneOperation.nodes
                      .getNode(0)
                      ._setAttribute(n.key, n.newValue)
                  : t._cloneOperation.nodes.getNode(0)._removeAttribute(n.key);
                break;
              }
            return [t];
          }),
          cu(Ka, za, (t, e, n) =>
            e.position &&
            t.position.root == e.position.root &&
            "same" === En(t.position.path, e.position.getParentPath())
              ? [e.getReversed(), t.clone()]
              : lu(t, e, n)
          ),
          cu(Ja, ja, (t, e) => {
          ...
          cu($a, za, (t, e, n) => {
            ...
            const o = t.range.start.root == e.position.root,
              i =
                o &&
                "same" ===
                  En(t.range.start.getParentPath(), e.position.getParentPath()),
              r =
                t.range.start.offset < e.position.offset &&
                t.range.end.offset >= e.position.offset;
            ...
            if (
              ...
              "same" ===
                En(
                  e.position.getParentPath(),
                  t.range.end.getShiftedBy(-1).path
                )
            ) {
              const e = t.clone();
              return (
                e._insertOperation.position.offset++,
                e._moveOperation.howMany++,
                e._moveOperation.targetPosition.path[
                  e._moveOperation.targetPosition.path.length - 2
                ]++,
                [e]
              );
            }
          ...
          cu(za, Ha, (t, e, n) => {
            ...
            if (i && !o && e.operations[0].position.isEqual(i)) {
              const n = e.clone();
              return (
                (n.operations[0].position = i.getShiftedBy(1)),
                (n.operations[0].oldName =
                  t._cloneOperation.nodes.getNode(0).name),
                [t, n]
              );
            }
            return [t];
          ...
          cu(Wa, za, (t, e, n) => {
            const o = lu(t, e, n),
              i =
                e._cloneOperation.position || e._cloneOperation.targetPosition;
            if (!i) return lu(t, e, n);
            if (n.undoMode) return o;
            for (const t of o)
              if (t instanceof Wa) {
                const e = t._moveOperation;
                e.sourcePosition.getShiftedBy(e.howMany).isEqual(i) &&
                  (e.howMany += 1);
              }
            return o;
          }),
          cu(za, Wa, (t, e, n) => {
            if (n.undoMode) return lu(t, e, n);
            const o =
              t._cloneOperation.position || t._cloneOperation.targetPosition;
            if (!o) return lu(t, e, n);
            const i = (e = e.clone())._moveOperation;
            return (
              i.sourcePosition.getShiftedBy(i.howMany).isEqual(o) &&
                (i.howMany += 1),
              lu(t, e, n)
            );
          });
        ...
        class bu {
          ...
          insert(t, e, n) {
            ...
            if (t.parent) {
              ...
              if (t.root.document)
                throw new Error(
                  "model-writer-insert-forbidden-move: Cannot move a node from a document to a different tree."
                );
              this.remove(t);
            }
          ...
          insertText(t, e, n, o) {
            e instanceof wa || e instanceof ms || e instanceof vs
          ...
          appendText(t, e, n) {
            e instanceof wa || e instanceof ms
          ...
          setAttribute(t, e, n) {
            this._assertWriterUsedCorrectly(),
              n instanceof _s ? wu(this, t, e, n) : vu(this, t, e, n);
          }
          setAttributes(t, e) {
          ...
          removeAttribute(t, e) {
            this._assertWriterUsedCorrectly(),
              e instanceof _s ? wu(this, t, null, e) : vu(this, t, null, e);
          }
          clearAttributes(t) {
            this._assertWriterUsedCorrectly();
            const e = (t) => {
          ...
          move(t, e, n) {
            if ((this._assertWriterUsedCorrectly(), !(t instanceof _s)))
              throw new m.b(
          ...
          rename(t, e) {
            if ((this._assertWriterUsedCorrectly(), !(t instanceof ms)))
              throw new m.b(
          ...
          split(t, e) {
            ...
            do {
              ...
              const c = null !== s ? s + 1 : null,
                l = new Sa(
                  t,
                  i.maxOffset - t.offset,
                  vs.createFromParentAndOffset(r, 0),
                  c
                );
              (l.isSticky = !0),
                e.addOperation(l),
                ...
                n || o || ((n = i), (o = r)),
                (i = (t = vs.createBefore(r)).parent);
            } while (i !== e);
            return {
              position: t,
              range: new _s(vs.createAt(n, "end"), vs.createAt(o)),
            };
          }
          wrap(t, e) {
          ...
          unwrap(t) {
            ...
            (i.isSticky = !0),
              ...
              ku(vs.createBefore(t), 1, e, this.model);
          }
          addMarker(t, e) {
            if (
              (this._assertWriterUsedCorrectly(),
            ...
            return n
              ? (_u(this, t, null, o, i), this.model.markers.get(t))
          ...
          removeMarker(t) {
            ...
            n.managedUsingOperations
              ? _u(this, e, n.getRange(), null, n.affectsData)
        ...
        function vu(t, e, n, o) {
          ...
          if (s != n) {
            ...
            if ((t.batch.addDelta(d), l)) {
              ...
              const t = (a = o.is("element")
                ? new _s(vs.createBefore(o), vs.createFromParentAndOffset(o, 0))
                : new _s(vs.createBefore(o), vs.createAfter(o))).root.document
                ? r.version
                : null;
              c = new Ta(a, e, s, n, t);
            }
        ...
        class xu {
          ...
          getChanges(t = { includeChangesInGraveyard: !1 }) {
            ...
            for (const t of this._changesInElement.keys()) {
              ...
              for (const n of r)
                if ("i" === n)
                  e.push(this._getInsertDiff(t, s, i[s].name)), s++;
                else if ("r" === n)
                  e.push(this._getRemoveDiff(t, s, o[a].name)), a++;
                else if ("a" === n) {
                  const n = i[s].attributes,
                    r = o[a].attributes;
                  let c;
                  if ("$text" == i[s].name)
                    c = _s.createFromParentsAndOffsets(t, s, t, s + 1);
                  else {
            ...
            return (
              ...
              (this._cachedChanges = e.slice().filter(Tu)),
          ...
          _makeSnapshot(t) {
            this._elementSnapshots.has(t) ||
              this._elementSnapshots.set(t, Au(t.getChildren()));
          }
          _handleChange(t, e) {
        ...
        function Cu(t, e) {
          ...
          for (const t of e)
            t.offset > o &&
              (n.push(..."e".repeat(t.offset - o).split("")),
              (i += t.offset - o)),
              "insert" == t.type
                ? (n.push(..."i".repeat(t.howMany).split("")),
                  (o = t.offset + t.howMany))
                : "remove" == t.type
                ? (n.push(..."r".repeat(t.howMany).split("")),
                  (o = t.offset),
                  (i += t.howMany))
        ...
        class Su {
          ...
          addDelta(t) {
            if (
              ...
              !this._historyPoints.has(t.baseVersion)
            ) {
          ...
          *getDeltas(t = 0, e = Number.POSITIVE_INFINITY) {
          ...
          _getIndex(t) {
            ...
            if (void 0 === e) {
              ...
              if (t < 0 || t >= n) return -1;
              throw new m.b(
                "model-history-wrong-version: Given base version points to the middle of a delta."
              );
            }
            return e;
          }
          ...
          constructor(t) {
              ...
              this.listenTo(
                ...
                (t, e) => {
                  ...
                  n.isDocumentOperation &&
                    (this.version++, this.history.addDelta(n.delta));
                },
                { priority: "low" }
              );
            let e = !1;
            this.listenTo(this.selection, "change", () => {
              ...
              this.listenTo(t, "_change", (t, n) => {
                (this.differ.isEmpty && !e) ||
                  (this._callPostFixers(n),
        ...
        class Mu {
          ...
          _set(t, e, n = !1, o = !1) {
            ...
            if (r) {
              ...
              return (
                t.isEqual(e) ||
                  (r._attachLiveRange(Ps.createFromRange(e)), (s = !0)),
                n != r.managedUsingOperations &&
                  ((r._managedUsingOperations = n), (s = !0)),
                "boolean" == typeof o &&
                  o != r.affectsData &&
                  ((r._affectsData = o), (s = !0)),
            ...
            const s = Ps.createFromRange(e),
              a = new Fu(i, s, n, o);
            return (
              this._markers.set(i, a), this.fire("update:" + i, a, null, e), a
            );
          }
          _remove(t) {
        ...
        class Vu extends vs {
          constructor(t, e, n) {
            if ((super(t, e), !this.root.is("rootElement")))
              throw new m.b(
                  ...
                  (e, n) => {
                    ...
                    o.isDocumentOperation &&
                      ...
                      function (t) {
                        let e, n;
                        "insert" == t.type
                          ? (e = _s.createFromPositionAndShift(
                              t.position,
                              t.nodes.maxOffset
                            ))
                          : ((e = _s.createFromPositionAndShift(
                        ...
                        switch (t.type) {
                          ...
                          case "reinsert":
                            const s = _s.createFromPositionAndShift(n, o),
                              a =
                                s.containsPosition(this) ||
                                (s.start.isEqual(this) &&
                                  "sticksToNext" == this.stickiness) ||
                                (s.end.isEqual(this) &&
                                  "sticksToPrevious" == this.stickiness);
        ...
        class Nu {
          ...
          _mergeSiblingsOf(t, e) {
            ...
            if (o) {
              this.position.isEqual(r) ||
                Ur.a.error(
                  "insertcontent-wrong-position-on-merge: The insertion position should equal the merge position"
                ),
                (this.position = vs.createAt(r.nodeBefore, "end"));
              const t = new Vu(
                this.position.root,
                this.position.path,
                "sticksToPrevious"
            ...
            (n || o) && this._filterAttributesOf.push(this.position.parent),
              i.detach(),
              r.detach();
          }
          _canMergeLeft(t, e) {
          ...
          _checkAndSplitToAllowedPosition(t) {
            ...
            for (; e != this.position.parent; ) {
              ...
              if (this.position.isAtStart) {
                const t = this.position.parent;
                (this.position = vs.createBefore(t)),
                  t.isEmpty && this.writer.remove(t);
              } else if (this.position.isAtEnd)
                this.position = vs.createAfter(this.position.parent);
              else {
        ...
        function Bu(t, e, n) {
          ...
          t.insert(o, e),
            n instanceof Rs ? t.setSelection(o, 0) : n.setTo(o, 0);
        }
        const Lu = ' ,.?!:;"-()';
        function ju(t, e, n = {}) {
          const o = t.schema,
        ...
        function zu(t, e) {
          ...
          if (e.type == (t.isForward ? "elementStart" : "elementEnd")) {
            if (t.schema.isObject(e.item))
              return vs.createAt(e.item, t.isForward ? "after" : "before");
        ...
        function $u(t, e) {
          return t.isCollapsed
            ? (function (t, e) {
                ...
                if (i.nodeAfter && e.isLimit(i.nodeAfter))
                  return new _s(i, vs.createAfter(i.nodeAfter));
                return new _s(i);
              })(t, e)
            : (function (t, e) {
                const n = t.start,
        ...
        class Gu {
          ...
          change(t) {
            return 0 === this._pendingChanges.length
              ? (this._pendingChanges.push({ batch: new fu(), callback: t }),
          ...
          enqueueChange(t, e) {
            "string" == typeof t
              ? (t = new fu(t))
              : "function" == typeof t && ((e = t), (t = new fu())),
          ...
          insertContent(t, e) {
            !(function (t, e, n) {
              t.change((o) => {
                ...
                let r;
                (r = e.is("documentFragment") ? e.getChildren() : [e]),
                  i.handleNodes(r, { isFirst: !0, isLast: !0 });
                ...
                s
                  ? n instanceof Rs
                    ...
                    : n.setTo(s)
                  : Ur.a.warn(
                      "insertcontent-no-range: Cannot determine a proper selection range after insertion."
                    );
              });
            })(this, t, e);
          }
                ...
                const c =
                  (a =
                    o.start.parent == o.end.parent
                      ? o
                      : _s.createFromParentsAndOffsets(
                          s,
                          o.start.path[r.length],
                          s,
                          o.end.path[r.length] + 1
          ...
          hasContent(t) {
            if ((t instanceof ms && (t = _s.createIn(t)), t.isCollapsed))
              return !1;
            for (const e of t.getItems())
              if (e.is("textProxy") || this.schema.isObject(e)) return !0;
            return !1;
          }
          destroy() {
        ...
        class Yu {
          constructor(t) {
            ...
            (this.config = new p(t, this.constructor.defaultConfig)),
              ...
              this.conversion.register("editingDowncast", [
                this.editing.downcastDispatcher,
              ]),
              this.conversion.register("dataDowncast", [
                this.data.downcastDispatcher,
              ]),
        ...
        class eh {
          constructor() {
            (this._domParser = new DOMParser()),
              (this._domConverter = new zi({ blockFiller: bi })),
              (this._htmlWriter = new th());
          }
          toData(t) {
        ...
        class ih {
          ...
          add(t) {
            if (this._elements.has(t))
              throw new m.b("focusTracker-add-element-already-exist");
        ...
        class rh {
          constructor(t, e) {
            (this.editor = t),
              (this.view = e),
              (this.componentFactory = new nh(t)),
          ...
          init() {
            ...
            e.render(),
              ...
              this._toolbarConfig.viewportTopOffset &&
                (e.stickyPanel.viewportTopOffset =
                  this._toolbarConfig.viewportTopOffset);
            ...
            e.editable.bind("isReadOnly").to(n),
              ...
              this.view.toolbar.fillFromConfig(
                ...
                e.isRendered || e.render(),
                  e.element &&
                    ...
                    this._parentElement.insertBefore(
                      e.element,
                      this._parentElement.children[n]
                    );
              }),
              this.on("remove", (t, e) => {
          ...
          *getViews() {
            ...
            t._isRendered &&
              ...
              (function t(e, n) {
                n.attributes &&
                  ...
                  yh(e.attributes, n.attributes));
                n.eventListeners &&
                  (e.eventListeners || (e.eventListeners = {}),
                  yh(e.eventListeners, n.eventListeners));
          ...
          _renderElement(t) {
            ...
            return (
              e ||
                (e = t.node =
                  document.createElementNS(this.ns || lh, this.tag)),
        ...
        function ph(t) {
          return (
            !!t &&
            (t.value && (t = t.value),
            Array.isArray(t) ? t.some(ph) : t instanceof uh)
          );
        }
        function mh(t, e, { node: n }) {
          ...
          xh(
            (o = 1 == t.length && t[0] instanceof fh ? o[0] : o.reduce(kh, ""))
          )
            ? e.remove()
            : e.set(o);
        }
        ...
        function vh(t) {
          if (
            ...
            t.attributes &&
              (function (t) {
                for (const e in t)
                  t[e].value && (t[e].value = [].concat(t[e].value)), _h(t, e);
              })(t.attributes);
            const e = [];
            if (t.children)
              if (Th(t.children)) e.push(t.children);
                ...
                for (const n of t.children)
                  Ch(n) || Ah(n) || Oi(n) ? e.push(n) : e.push(new dh(n));
            t.children = e;
          }
          return t;
        }
        ...
        class Eh {
          ...
          get bindTemplate() {
            return this._bindTemplate
              ? this._bindTemplate
              : (this._bindTemplate = dh.bind(this, this));
          }
          createCollection() {
            const t = new ah();
        ...
        class Ih extends Eh {
              ...
              this.setTemplate({
                ...
                attributes: {
                  class: [
                    ...
                    "ck-editor__editable",
                    "ck-rounded-corners",
                    n.to("isFocused", (t) => (t ? "ck-focused" : "ck-blurred")),
                  ],
          ...
          destroy() {
            this.externalElement && this.template.revert(this.externalElement),
              super.destroy();
          }
        }
        class Mh extends Ih {
                ...
                attributes: {
                  ...
                  style: {
                    ...
                    height: e.to("isSticky", (t) =>
                      t ? Vh(this._panelRect.height) : null
                    ),
                  },
                },
              }).render()),
                ...
                attributes: {
                  ...
                  style: {
                    ...
                    top: e.to("_hasViewportTopOffset", (t) =>
                      t ? Vh(this.viewportTopOffset) : null
                    ),
                    bottom: e.to("_isStickyToTheLimiter", (t) =>
                      t ? Vh(this.limiterBottomOffset) : null
                    ),
        ...
        function Bh(t) {
          return !(
            !t.focus || "none" == Di.window.getComputedStyle(t.element).display
          );
        }
        class Lh extends Eh {
          constructor(t) {
              ...
              this.setTemplate({
                ...
                attributes: {
                  class: [
                    "ck",
                    "ck-toolbar",
                    e.if("isVertical", "ck-toolbar_vertical"),
                    e.to("className"),
                  ],
                },
                children: this.items,
        ...
        class zh extends Rh {
          constructor(t) {
            super(t),
              (this.stickyPanel = new Nh(t)),
              (this.toolbar = new jh(t)),
              (this.editable = new Mh(t));
          }
          render() {
            super.render(),
            ...
            return new Promise((n) => {
              ...
              n(
                o
                  ...
                  .then(() => o.ui.init())
                  .then(() => {
                    ji(t) && o._elementReplacer.replace(t, o.element),
                      o.fire("uiReady");
                  })
                  .then(() =>
                    o.editing.view.attachDomRoot(o.ui.view.editableElement)
                  )
                  .then(() => {
                    const e = ji(t)
                      ? (function (t) {
                        ...
                        if (e.is("text") || e.is("textProxy")) n = e.data;
                          ...
                          for (const i of e.getChildren()) {
                            ...
                            o &&
                              ...
                              (Kh.includes(o.name) || Kh.includes(i.name)
                                ? (n += "\n")
                                : (n += "\n\n")),
                              (n += e),
                              (o = i);
          ...
          constructor(t) {
            (this.editor = t),
              ...
              this.listenTo(t, "change:isReadOnly", (t, e, n) => {
                n
                  ? (this.on("set:isEnabled", Qh, { priority: "highest" }),
                    (this.isEnabled = !1))
                  : (this.off("set:isEnabled", Qh), this.refresh());
              });
          }
          refresh() {
            this.isEnabled = !0;
              ...
              !(function (t, e, n, o) {
                ...
                if (i) Xh(e, n, r.start);
                  ...
                  t.deleteContent(n, { leaveUnmerged: o }),
                    o && (i ? Xh(e, n, n.focus) : e.setSelection(a, 0));
                }
        ...
        function Xh(t, e, n) {
          ...
          n.isAtEnd
            ? t.insert(i, n.parent, "after")
            : n.isAtStart
            ? t.insert(i, n.parent, "before")
            : t.split(n),
            t.setSelection(n.parent.nextSibling, 0);
        }
        class Zh extends Gi {
          constructor(t) {
            super(t);
            ...
            e.on("keydown", (t, n) => {
              if (this.isEnabled && n.keyCode == Xo.enter) {
                ...
                e.once("enter", (t) => (o = t), { priority: "highest" }),
                  e.fire(
                    "enter",
                    new Fr(e, n.domEvent, { isSoft: n.shiftKey })
                  ),
            ...
            t.change((n) => {
              !(function (t, e, n) {
                ...
                if (o) nf(e, i.end);
                  ...
                  t.deleteContent(n, { leaveUnmerged: o }),
                    a ? nf(e, n.focus) : o && e.setSelection(s, 0);
                }
              })(t, n, e.selection),
                this.fire("afterExecute", { writer: n });
            });
          ...
          execute(t = {}) {
            ...
            e.enqueueChange(this._buffer.batch, (t) => {
              ...
              this._buffer.lock(),
                ...
                s
                  ? t.setSelection(s)
                  : e && t.setSelection(r.start.getShiftedBy(i)),
                this._buffer.unlock(),
        ...
        function hf(t, e) {
          return t instanceof On && e instanceof On
            ? t.data === e.data
            : t === e;
        }
        class ff {
        ...
        class bf extends Jh {
          constructor(t, e) {
            super(t),
              (this.direction = e),
              (this._buffer = new sf(t.model, t.config.get("typing.undoStep")));
          }
          execute(t = {}) {
            const e = this.editor.model,
              n = e.document;
            e.enqueueChange(this._buffer.batch, (o) => {
              ...
              if (
                ...
                this._shouldEntireContentBeReplacedWithParagraph(
                  t.sequence || 1
                ))
              )
        ...
        class wf extends Gi {
          constructor(t) {
            ...
            e.on("keyup", (t, e) => {
              ...
              e.on("keydown", (t, o) => {
                const i = {};
                if (o.keyCode == Xo.delete)
                  (i.direction = "forward"), (i.unit = "character");
                else {
                ...
                (i.unit = r ? "word" : i.unit),
                  (i.sequence = ++n),
                  e.once("delete", (t) => (s = t), { priority: "highest" }),
                  e.fire("delete", new Fr(e, o.domEvent, i)),
                  s && s.stop.called && t.stop();
              });
          }
          observe() {}
        }
          ...
          init() {
            ...
            e.addObserver(wf),
              ...
              this.listenTo(n, "delete", (n, o) => {
                t.execute(
                  "forward" == o.direction ? "forwardDelete" : "delete",
                  { unit: o.unit, sequence: o.sequence }
                ),
                  o.preventDefault(),
                  e.scrollToTheSelection();
              }),
            ...
            for (const n of e)
              for (const e of n.operations)
                for (let n = 0; n < t.length; n++) {
                  ...
                  switch (e.type) {
                    case "insert":
                      o = t[n]._getTransformedByInsertion(
                        e.position,
                        e.nodes.maxOffset,
                        !0
                      );
        ...
        class Cf extends xf {
          execute(t = null) {
            ...
            this.editor.model.enqueueChange(o, () => {
              ...
              const t = this.editor.model.document.history.getDeltas(
                n.batch.baseVersion
              );
              ...
              this.listenTo(
                ...
                (t, e) => {
                  ...
                  this._batchRegistry.has(o) ||
                    "transparent" == o.type ||
                    (this._redoCommand._createdBatches.has(o)
                      ? this._undoCommand.addBatch(o)
                      : this._undoCommand._createdBatches.has(o) ||
                        (this._undoCommand.addBatch(o),
        ...
        class Vf extends Wh {
          init() {
            ...
            this._addButton("undo", t("ai"), "CTRL+Z", If.a),
              this._addButton("redo", t("aj"), "CTRL+Y", Ff.a);
          }
          _addButton(t, e, n, o) {
            const i = this.editor;
            i.ui.componentFactory.add(t, (r) => {
              ...
              return (
                ...
                this.listenTo(a, "execute", () => i.execute(t)),
                a
              );
            });
          }
        ...
        class Df extends Wh {
          ...
          init() {
            this.set("hasAny", !1),
              (this._actions = new jo({ idProperty: "_id" })),
              this._actions.delegate("add", "remove").to(this);
          }
          add(t) {
            if ("string" != typeof t)
              throw new m.b(
                "pendingactions-add-invalid-message: The message must be a string."
              );
          ...
          upload() {
            ...
            return (
              ...
              this._adapter
                .upload()
                .then(
                  (t) => ((this.uploadResponse = t), (this.status = "idle"), t)
                )
                .catch((t) => {
        ...
        class Hf {
          ...
          _initListeners(t, e) {
            ...
            n.addEventListener("error", () => e(i)),
              ...
              n.addEventListener("load", () => {
                ...
                if (!o || !o.uploaded)
                  return e(
                    o && o.error && o.error.message ? o.error.message : i
                  );
                t({ default: o.url });
              }),
              n.upload &&
          ...
          _sendRequest() {
            ...
            t.append("upload", this.loader.file),
              t.append("ckCsrfToken", Wf()),
              this.xhr.send(t);
          }
        }
        class $f {
            ...
            t.model.document.on("change", (n, i) => {
              ...
              c &&
                t.model.enqueueChange((t) => {
                  const e = _s.createFromParentsAndOffsets(
                    a.parent,
                    0,
                    a.parent,
                    c[0].length
        ...
        function Gf(t, e) {
          return e
            ...
            .map((e) => _s.createFromParentsAndOffsets(t, e[0], t, e[1]));
        }
        class Jf extends Jh {
          constructor(t, e) {
          ...
          init() {
            ...
            t.ui.componentFactory.add(tp, (n) => {
              ...
              return (
                ...
                this.listenTo(i, "execute", () => t.execute(tp)),
                i
              );
            });
          }
          ...
          init() {
            ...
            t.ui.componentFactory.add(sp, (n) => {
              ...
              return (
                ...
                i.bind("isOn", "isEnabled").to(o, "value", "isEnabled"),
                this.listenTo(i, "execute", () => t.execute(sp)),
                i
              );
            });
          }
          ...
          _applyQuote(t, e) {
            ...
            up(e)
              ...
              n
                .reverse()
                .reduce((e, n) =>
                  e.nextSibling == n ? (t.merge(vs.createAfter(e)), e) : n
                );
          }
        }
        function dp(t) {
        ...
        function up(t) {
          ...
          for (; n < t.length; ) {
            const i = t[n],
              r = t[n + 1];
            e || (e = vs.createBefore(i)),
              (r && i.nextSibling == r) ||
                (o.push(new _s(e, vs.createAfter(i))), (e = null)),
              n++;
          }
          return o;
        }
        ...
        class fp extends Wh {
          init() {
            ...
            t.commands.add("blockQuote", new lp(t)),
              ...
              e.addChildCheck((t, e) => {
                if (t.endsWith("blockQuote") && "blockQuote" == e.name)
                  return !1;
              }),
          ...
          init() {
            ...
            t.ui.componentFactory.add("blockQuote", (n) => {
              const o = t.commands.get("blockQuote"),
                i = new Of(n);
              return (
                i.set({ label: e("b"), icon: mp.a, tooltip: !0 }),
                i.bind("isOn", "isEnabled").to(o, "value", "isEnabled"),
                this.listenTo(i, "execute", () => t.execute("blockQuote")),
                i
              );
            });
          }
        ...
        class kp {
          constructor(t, e = _p) {
            ...
            this.set("value", e.initValue),
              (this._tokenUrl = t),
              (this._options = Object.assign({}, _p, e));
          }
          init() {
            return new Promise((t, e) => {
              ...
              n.open("GET", this._tokenUrl),
                n.addEventListener("load", () => {
                  const o = n.status,
                    i = n.response;
                  return o < 200 || o > 299
                    ? e("Cannot download new token!")
                    : (this.set("value", i), t(this));
                }),
        ...
        class xp extends Wh {
          init() {
            ...
            if (this.tokenUrl)
              return (
                (this.token = new xp.Token(this.tokenUrl)), this.token.init()
              );
            this.token = null;
          }
        }
        ...
        class Ap extends Wh {
          ...
          init() {
            const t = this.editor,
              ...
              o = e.uploadUrl;
            n &&
              ((this._uploadGateway = new Ap._UploadGateway(n, o)),
              (t.plugins.get(Lf).createUploadAdapter = (t) =>
                new Cp(this._uploadGateway, t)));
          }
        }
        class Cp {
          constructor(t, e) {
          ...
          observe(t, e) {
            this.document.getRoot(e).on("change:children", (e, n) => {
              this.view.once("render", () =>
                this._updateObservedElements(t, n)
              );
            });
          }
            ...
            if (n) {
              for (const t of n.querySelectorAll("img"))
                this._observedElements.has(t) ||
                  (this.listenTo(t, "load", (t, e) => this._fireEvents(e)),
                  this._observedElements.add(t));
              for (const e of this._observedElements)
                t.contains(e) ||
                  (this.stopListening(e), this._observedElements.delete(e));
            }
          }
          _fireEvents(t) {
            this.isEnabled &&
        ...
        function Pp(t, e) {
          return (
            t && e && t.priority == e.priority && Rp(t.classes) == Rp(e.classes)
          );
        }
        function Op(t, e) {
          return (
            t.priority > e.priority ||
            (!(t.priority < e.priority) && Rp(t.classes) > Rp(e.classes))
          );
        }
        function Rp(t) {
          ...
          return (
            ...
            n.hasSelectionHandler &&
              (function (t, e) {
                ...
                e.insert(Fo.createAt(t), n),
                  e.addClass(["ck-widget_selectable"], t);
              })(t, e),
            (function (t, e, n, o) {
              const i = new Ep();
              i.on("change:top", (e, i) => {
                i.oldDescriptor && o(t, i.oldDescriptor, i.writer),
                  i.newDescriptor && n(t, i.newDescriptor, i.writer);
              }),
                e.setCustomProperty(
                  "addHighlight",
                  (t, e, n) => i.add(e, n),
        ...
        class Hp extends Wh {
          init() {
            ...
            t.editing.view.addObserver(Tp),
              ...
              o
                .for("dataDowncast")
                .add(Vs({ model: "image", view: (t, e) => $p(e) })),
                  ...
                  (function () {
                    ...
                    function t(t, e, n) {
                      if (
                        ...
                        return;
                      const o = Array.from(e.viewItem.getChildren()).find((t) =>
                        t.is("img")
                      );
                      if (
                        !o ||
                        !o.hasAttribute("src") ||
                        !n.consumable.test(o, { name: !0 })
                      )
                        return;
                      const i = n.convertItem(o, e.modelCursor),
                        r = cp(i.modelRange.getItems());
                      r &&
                        (n.convertChildren(e.viewItem, vs.createAt(r)),
                        (e.modelRange = i.modelRange),
                        (e.modelCursor = i.modelCursor));
                    }
                  })()
                );
          }
        ...
        class Jp extends Wh {
          ...
          _onKeydown(t, e) {
            ...
            !(function (t) {
              ...
              ? !(function (t) {
                ...
                : (i =
                    this._selectAllNestedEditableContent() ||
          ...
          _handleArrowKeys(t) {
            ...
            return r instanceof ms && n.isObject(r)
        ...
        class Zp extends Eh {
          constructor(t, e) {
            ...
            this.set("label"),
              ...
              this.set("isReadOnly", !1),
              (this.labelView = this._createLabelView(n)),
              (this.inputView = this._createInputView(e, n));
        ...
        class um extends Eh {
          ...
          _stopPinning() {
            this.stopListening(Di.document, "scroll"),
              this.stopListening(Di.window, "resize");
          }
        }
        function hm(t) {
          return ji(t)
        ...
        (um.arrowHorizontalOffset = 25),
          ...
          (um._getOptimalPosition = function ({
            element: t,
            target: e,
            positions: n,
            limiter: o,
            ...
            const r = (function (t) {
                for (; t && "html" != t.tagName.toLowerCase(); ) {
                  if ("static" != Di.window.getComputedStyle(t).position)
                    return t;
                  t = t.parentElement;
                }
                return null;
        ...
        class mm extends Wh {
          ...
          add(t) {
            ...
            this.visibleView && this.view.content.remove(this.visibleView),
              this._stack.set(t.view, t),
              this._show(t);
          }
          remove(t) {
            if (!this.hasView(t))
              throw new m.b(
                "contextualballoon-remove-view-not-exist: Cannot remove configuration of not existing view."
              );
          ...
          updatePosition(t) {
            t && (this._stack.get(this.visibleView).position = t),
              this.view.pin(this._getBalloonPosition());
          }
          _show({ view: t, balloonClassName: e = "" }) {
            (this.view.className = e),
        ...
        class _m extends Wh {
          ...
          _createButton() {
            ...
            t.ui.componentFactory.add("imageTextAlternative", (n) => {
              const o = t.commands.get("imageTextAlternative"),
                i = new Of(n);
              return (
                i.set({ label: e("x"), icon: bm.a, tooltip: !0 }),
                i.bind("isEnabled").to(o, "isEnabled"),
                this.listenTo(i, "execute", () => this._showForm()),
                i
              );
            });
          }
          ...
          _showForm() {
            ...
            this._balloon.hasView(this._form) ||
              this._balloon.add({ view: this._form, position: vm(t) }),
        ...
        class Im extends Wh {
          constructor(t) {
            super(t),
              (this.placeholder =
                "data:image/svg+xml;utf8," + encodeURIComponent(Rm.a));
          }
          init() {
            this.editor.editing.downcastDispatcher.on(
        ...
        class jm extends Jh {
          execute(t) {
            ...
            e.model.change((r) => {
              ...
              let c;
              (c = t.insertAt ? new Ts([new _s(t.insertAt)]) : n.selection),
                e.model.insertContent(a, c),
                a.parent && r.setSelection(a, "on");
            });
          }
        }
        class zm extends Wh {
              ...
              this.listenTo(
                ...
                (n, i) => {
                  if (
                    ...
                    return;
                  let r = new Ts(
                    i.targetRanges.map((e) => t.editing.mapper.toModelRange(e))
                  );
                    ...
                    if (Sm(s)) {
                      ...
                      t.model.change((n) => {
                        ...
                        const r = n.createElement("image", { uploadId: i.id }),
                          a = new Ts([new _s(e)]);
                        t.model.insertContent(r, a),
                          r.parent && n.setSelection(r, "on");
                      }),
                        n.stop();
                    }
                    r = e.selection;
            ...
            return (
              ...
              t
                ...
                .catch((n) => {
                  ...
                  "error" == t.status &&
                    s.showWarning(n, { title: i("r"), namespace: "upload" }),
                    a(),
                    o.enqueueChange("transparent", (t) => {
                      t.remove(e);
                    });
        ...
        class Wm extends Jh {
          refresh() {
            ...
            (this.value = !!e && e.is("paragraph")),
              (this.isEnabled = !!e && Hm(e, t.schema));
          }
          execute(t = {}) {
            const e = this.editor.model,
              n = e.document;
        ...
        class $m extends Wh {
            ...
            t.commands.add("paragraph", new Wm(t)),
                ...
                (t, e, n) => {
                  if (n.consumable.test(e.viewItem, { name: e.viewItem.name }))
                    if ($m.paragraphLikeElements.has(e.viewItem.name)) {
                      ...
                      const { modelRange: i } = n.convertChildren(
                        e.viewItem,
                        vs.createAt(t)
                      );
                      (e.modelRange = new _s(vs.createBefore(t), i.end)),
                        (e.modelCursor = e.modelRange.end);
                    } else
                      Gm(e.viewItem, e.modelCursor, n.schema) &&
                        (e = Object.assign(
                          e,
                          Km(e.viewItem, e.modelCursor, n)
                        ));
                },
                { priority: "low" }
              ),
              n.upcastDispatcher.on(
                ...
                (t, e, n) => {
                  e.modelRange ||
                    (Gm(e.viewItem, e.modelCursor, n.schema) &&
                      (e = Object.assign(e, Km(e.viewItem, e.modelCursor, n))));
                },
                { priority: "lowest" }
              ),
              e.document.registerPostFixer((t) =>
                this._autoparagraphEmptyRoots(t)
              ),
              t.on(
                "dataReady",
                () => {
                  e.enqueueChange("transparent", (t) =>
                    this._autoparagraphEmptyRoots(t)
                  );
                },
                { priority: "lowest" }
          ...
          _autoparagraphEmptyRoots(t) {
            ...
            for (const n of e.document.getRootNames()) {
              ...
              if (
                o.isEmpty &&
                "$graveyard" != o.rootName &&
                e.schema.checkChild(o, "paragraph")
              )
        ...
        function Gm(t, e, n) {
          ...
          return (
            ...
            !!n.checkChild(o.push("paragraph"), t)
          );
        }
        $m.paragraphLikeElements = new Set([
          "blockquote",
          "dd",
          "div",
          "dt",
            ...
            (this.value = !!t && this.modelElements.includes(t.name) && t.name),
              (this.isEnabled =
                ...
                this.modelElements.some((e) =>
                  Qm(t, e, this.editor.model.schema)
                ));
          }
          execute(t) {
            const e = this.editor.model,
          ...
          afterInit() {
            ...
            e &&
              this.listenTo(e, "afterExecute", (e, o) => {
                ...
                n.some((t) => i.is(t.model)) &&
                  !i.is(Ym) &&
                  0 === i.childCount &&
                  o.writer.rename(i, Ym);
              });
          }
        }
        class Zm {
        ...
        function fg(t, e, n) {
          ...
          let r = !1;
          if (!o) return !1;
          e.getAttribute("data-placeholder") !== i &&
            (t.setAttribute("data-placeholder", i, e), (r = !0));
          const s = o.selection.anchor,
            a = n.checkFunction;
          if (a && !a())
            return (
              e.hasClass("ck-placeholder") &&
                (t.removeClass("ck-placeholder", e), (r = !0)),
              r
            );
          const c = !Array.from(e.getChildren()).some(
            (t) => !t.is("uiElement")
          );
          return !o.isFocused && c
            ? (e.hasClass("ck-placeholder") ||
                (t.addClass("ck-placeholder", e), (r = !0)),
              r)
            : (c && s && s.parent !== e
                ? e.hasClass("ck-placeholder") ||
                  (t.addClass("ck-placeholder", e), (r = !0))
        ...
        function gg(t) {
          for (const e of t.getChildren())
            if (e instanceof ms && "caption" == e.name) return e;
          return null;
        }
        function bg(t) {
          const e = t.parent;
          return "figcaption" == t.name &&
            e &&
            "figure" == e.name &&
            e.hasClass("image")
            ? { name: !0 }
        ...
        class wg extends Wh {
          init() {
            ...
            n.register("caption", {
              ...
              t.model.document.registerPostFixer((t) =>
                this._insertMissingModelCaptionElement(t)
              ),
              t.conversion
                .for("upcast")
                .add(aa({ view: bg, model: "caption" }));
            ...
            i.downcastDispatcher.on("insert:caption", vg(s)),
              ...
              e.document.registerPostFixer((t) =>
                this._updateCaptionVisibility(t)
              );
          }
          _updateCaptionVisibility(t) {
            ...
            if ((s && (o = e.toViewElement(s)), o))
              return n
                ? n === o
                  ? yg(o, t)
                  : (kg(n, t), (this._lastSelectedCaption = o), yg(o, t))
                : ((this._lastSelectedCaption = o), yg(o, t));
            if (n) {
              const e = kg(n, t);
        ...
        function kg(t, e) {
          return (
            !t.childCount &&
            !t.hasClass("ck-hidden") &&
            (e.addClass("ck-hidden", t), !0)
          );
        }
        function yg(t, e) {
          return (
            !!t.hasClass("ck-hidden") && (e.removeClass("ck-hidden", t), !0)
          );
        }
        n(83);
        class xg extends Jh {
          constructor(t, e) {
            super(t),
              (this._defaultStyle = !1),
              (this.styles = e.reduce(
                (t, e) => (
                  (t[e.name] = e),
                  e.isDefault && (this._defaultStyle = e.name),
                  t
                ),
                {}
              ));
          ...
          execute(t) {
            ...
            n.change((t) => {
              this.styles[e].isDefault
                ? t.removeAttribute("imageStyle", o)
                : t.setAttribute("imageStyle", e, o);
            });
          }
        }
        function Ag(t, e) {
                ...
                (function (t) {
                  ...
                  return (t, n, o) => {
                    ...
                    if (o.schema.checkAttribute(r, "imageStyle"))
                      for (const t of e)
                        o.consumable.consume(i, { classes: t.className }) &&
        ...
        class Bg extends Wh {
          ...
          init() {
            const t = (function (t, e) {
              ...
              Vg(this.editor.config.get("image.styles")),
        ...
        function zg(t, e, n) {
          ...
          for (; o && o.getAttribute("linkHref") == e; )
            (i = o), (o = n ? o.previousSibling : o.nextSibling);
          ...
          execute() {
            ...
            t.change((t) => {
              const n = e.isCollapsed
                ? [jg(e.getFirstPosition(), e.getAttribute("linkHref"))]
                : e.getRanges();
        ...
        class Jg {
              ...
              e.listenTo(this._modelSelection, "change:range", (t, e) => {
                this._isNextGravityRestorationSkipped
                  ...
                  : this._isGravityOverridden &&
                    ((!e.directChange &&
                      Qg(this._modelSelection.getFirstPosition(), n)) ||
          ...
          handleForwardMovement(t, e) {
            ...
            if (
              !(
                this._isGravityOverridden ||
                (t.isAtStart && this._hasSelectionAttribute)
              )
            )
          ...
          _overrideGravity() {
            this._overrideUid = this.model.change((t) =>
          ...
          _setSelectionAttributeFromTheNodeBefore(t) {
            ...
            this.model.change((n) => {
              n.setSelectionAttribute(
                this.attribute,
                t.nodeBefore.getAttribute(e)
              );
            });
          }
        ...
        function Yg(t, e) {
          ...
          return (
            !!o &&
            o.hasAttribute(e) &&
            (!i || n.getAttribute(e) !== o.getAttribute(e))
          );
        }
        function Xg(t, e) {
          const { nodeBefore: n, nodeAfter: o } = t,
        ...
        function Zg(t, e) {
          const { nodeBefore: n, nodeAfter: o } = t,
            i = !!n && n.hasAttribute(e);
          if (!!o && o.hasAttribute(e) && i)
            return o.getAttribute(e) !== n.getAttribute(e);
        }
        function tb(t, e) {
        ...
        class nb extends Wh {
          init() {
            ...
            t.model.schema.extend("$text", { allowAttributes: "linkHref" }),
              t.conversion
                .for("dataDowncast")
                .add(Ns({ model: "linkHref", view: Kg })),
              t.conversion
                .for("editingDowncast")
                .add(Ns({ model: "linkHref", view: (t, e) => Kg(Gg(t), e) })),
              ...
              (function (t, e, n, o) {
                ...
                n.listenTo(
                  ...
                  (t, e) => {
                    ...
                    let a;
                    (a = n
                      ? i.handleForwardMovement(s, e)
                      : i.handleBackwardMovement(s, e)) && t.stop();
                  },
            ...
            e.document.registerPostFixer((e) => {
              ...
              if (o.hasAttribute("linkHref")) {
                ...
                for (const t of r.getItems())
                  t.is("a") && (e.addClass(eb, t), n.add(t));
              }
            }),
                ...
                function o() {
                  e.change((t) => {
                    for (const e of n.values())
                      t.removeClass(eb, e), n.delete(e);
                  });
                }
                t.on("insert", o, { priority: "highest" }),
                  t.on("remove", o, { priority: "highest" }),
                  t.on("attribute", o, { priority: "highest" }),
                  t.on("selection", o, { priority: "highest" });
              });
          }
        }
        class ob extends Vr {
        ...
        class fb extends Wh {
          ...
          _createFormView() {
            ...
            return (
              ...
              this.listenTo(e, "submit", () => {
                t.execute("link", e.urlInputView.inputView.element.value),
          ...
          //         this.listenTo(o, "execute", () => this._showUI()),
          //         o
          //       );
          //     });
          // }
          ...
          _showUI() {
            this.editor.commands.get("link").isEnabled &&
              (this._getSelectedLinkElement()
                ...
                : (this._addActionsView(), this._addFormView()),
          ...
          _getSelectedLinkElement() {
            ...
            if (t.isCollapsed) return pb(t.getFirstPosition());
            {
              const e = t.getFirstRange().getTrimmed(),
                n = pb(e.start),
                o = pb(e.end);
              return n && n == o && Vo.createIn(n).getTrimmed().isEqual(e)
                ? n
                : null;
            }
          }
        ...
        class mb extends Jh {
          ...
          execute() {
            const t = this.editor.model,
              e = t.document,
              n = Array.from(e.selection.getSelectedBlocks()).filter((e) =>
                bb(e, t.schema)
              ),
              o = !0 === this.value;
            t.change((t) => {
          ...
          _getValue() {
            ...
            return (
              !!t && t.is("listItem") && t.getAttribute("listType") == this.type
            );
          }
          _checkEnabled() {
            if (this.value) return !0;
        ...
        class wb extends Jh {
          ...
          _checkEnabled() {
            ...
            if (this._indentBy > 0) {
              ...
              for (
                ;
                o && o.is("listItem") && o.getAttribute("listIndent") >= e;
        ...
        function _b(t, e, n) {
          ...
          if (
            !o.test(e.item, "insert") ||
            !o.test(e.item, "attribute:listType") ||
            !o.test(e.item, "attribute:listIndent")
          )
            return;
          o.consume(e.item, "insert"),
            o.consume(e.item, "attribute:listType"),
            o.consume(e.item, "attribute:listIndent");
          const i = e.item;
          Fb(
            i,
            (function (t, e) {
        ...
        function kb(t, e, n) {
          const o = n.mapper
            ...
            i = n.writer;
          i.breakContainer(Fo.createBefore(o)),
            i.breakContainer(Fo.createAfter(o));
          const r = o.parent,
            s = r.previousSibling,
            a = Vo.createOn(r),
            c = i.remove(a);
          s && s.nextSibling && Mb(i, s, s.nextSibling),
            Vb(
              n.mapper.toModelElement(o).getAttribute("listIndent") + 1,
              e.position,
              a.start,
              o,
              n
            );
          for (const t of Vo.createIn(c).getItems())
            n.mapper.unbindViewElement(t);
          t.stop();
        }
        function yb(t, e, n) {
          ...
          Mb(i, (r = i.rename(r, s)), r.nextSibling),
            Mb(i, r.previousSibling, r);
        ...
        function xb(t, e, n) {
          ...
          i.remove(a),
            s && s.nextSibling && Mb(i, s, s.nextSibling),
            Vb(e.attributeOldValue + 1, e.range.start, a.start, o, n),
            Fb(e.item, o, n);
          for (const t of e.item.getChildren())
            n.consumable.consume(t, "insert");
        }
        function Ab(t, e, n) {
          if ("listItem" != e.item.name) {
            ...
            for (
              ...
              "li" == (t = o.breakContainer(t)).parent.name;
        ...
        function Tb(t, e, n) {
          if (n.consumable.consume(e.viewItem, { name: !0 })) {
            ...
            (o.indent = o.indent || 0),
              t.setAttribute("listIndent", o.indent, i);
            const r =
            ...
            for (const t of e.viewItem.getChildren())
              "ul" == t.name || "ol" == t.name
                ? (a = n.convertItem(t, a).modelCursor)
                : n.convertItem(t, vs.createAt(i, "end"));
            o.indent--,
              (e.modelRange = new _s(e.modelCursor, a)),
              s.cursorParent
                ? (e.modelCursor = vs.createAt(s.cursorParent))
                : (e.modelCursor = e.modelRange.end);
          }
        }
        function Sb(t, e, n) {
        ...
        function Ob(t, e) {
          ...
          if ("ul" == o.name || "ol" == o.name) {
            ...
            let s = 1,
              a = n.nodeBefore;
            for (; a && (a.is("ul") || a.is("ol")); )
              (s += i.getModelLength(a)), (a = a.previousSibling);
        ...
        function Mb(t, e, n) {
          return e &&
            ...
            ("ul" == e.name || "ol" == e.name) &&
            e.name == n.name
            ? t.mergeContainers(Fo.createAfter(e))
            : null;
        }
        function Fb(t, e, n) {
          const o = e.parent,
          ...
          if (
            a &&
            a.getAttribute("listIndent") == t.getAttribute("listIndent")
          ) {
            ...
            s =
              c && "listItem" == c.name
                ? i.toViewPosition(vs.createAt(c, "end"))
                : i.toViewPosition(vs.createBefore(t));
          if (((s = Nb(s)), r.insert(s, o), c && "listItem" == c.name)) {
            const t = i.toViewElement(c),
              n = new Mo({
                boundaries: new Vo(Fo.createAt(t, 0), s),
                ignoreElementEnd: !0,
              });
            for (const t of n)
              if (t.item.is("li")) {
                const o = r.breakContainer(Fo.createBefore(t.item)),
                  i = t.item.parent,
                  s = Fo.createAt(e, "end");
                Mb(r, s.nodeBefore, s.nodeAfter),
                  r.move(Vo.createOn(i), s),
                  (n.position = o);
              }
          } else {
            ...
            if (n && (n.is("ul") || n.is("ol"))) {
              ...
              o &&
                (r.breakContainer(Fo.createAfter(o)),
                r.move(Vo.createOn(o.parent), Fo.createAt(e, "end")));
            }
          }
        ...
        function Vb(t, e, n, o, i) {
          ...
          for (const t of [...o.getChildren()])
            (t.is("ul") || t.is("ol")) &&
              ((l = a.move(Vo.createOn(t), l).end),
              Mb(a, t, t.nextSibling),
              Mb(a, t.previousSibling, t));
        }
        function Nb(t) {
        ...
        class Db extends Wh {
          ...
          init() {
              ...
              (function (t, e) {
                ...
                function r(t) {
                  ...
                  if (e && e.is("listItem")) {
                    ...
                    for (
                      ;
                      n.previousSibling && n.previousSibling.is("listItem");
            ...
            this.editor.keystrokes.set("Tab", i("indentList")),
              this.editor.keystrokes.set("Shift+Tab", i("outdentList"));
          }
        }
        function Bb(t) {
          let e = 1;
          for (const n of t.getChildren())
            if ("ul" == n.name || "ol" == n.name)
              for (const t of n.getChildren()) e += Bb(t);
          return e;
        }
        var Lb = n(30),
          jb = n.n(Lb),
        ...
        class Ub extends Wh {
          init() {
            const t = this.editor.t;
            this._addButton("numberedList", t("n"), jb.a),
              this._addButton("bulletedList", t("o"), qb.a);
          }
          _addButton(t, e, n) {
            const o = this.editor;
            o.ui.componentFactory.add(t, (i) => {
              ...
              return (
                ...
                this.listenTo(s, "execute", () => o.execute(t)),
                s
              );
            });
          }
        ...
        (Wb.builtinPlugins = [
          ...
          class extends Wh {
            ...
            init() {
              ...
              t &&
                (this.editor.plugins.get(Lf).createUploadAdapter = (e) =>
                  new Hf(e, t, this.editor.t));
            }
          },
          class extends Wh {
            static get pluginName() {
            ...
            _addListAutoformats() {
              ...
              t.get("bulletedList") &&
                new $f(this.editor, /^[*-]\s$/, "bulletedList"),
                t.get("numberedList") &&
                  new $f(this.editor, /^\d+[.|)]\s$/, "numberedList");
            }
            _addBasicStylesAutoformats() {
              const t = this.editor.commands;
              t.get("bold") &&
                (new Kf(this.editor, /(\*\*)([^*]+)(\*\*)$/g, "bold"),
                new Kf(this.editor, /(__)([^_]+)(__)$/g, "bold")),
                t.get("italic") &&
                  (new Kf(
                    this.editor,
                    /(?:^|[^*])(\*)([^*_]+)(\*)$/g,
                  ...
                  new Kf(this.editor, /(?:^|[^_])(_)([^_]+)(_)$/g, "italic")),
            ...
            _addBlockQuoteAutoformats() {
              this.editor.commands.get("blockQuote") &&
                new $f(this.editor, /^>\s$/, "blockQuote");
            }
          },
          class extends Wh {
            static get requires() {
          ...
          class extends Wh {
            ...
            _checkIsVisible() {
              const t = this.editor;
              t.ui.focusTracker.isFocused &&
              Up(t.editing.view.document.selection)
                ? this._showToolbar()
                : this._hideToolbar();
            }
            _showToolbar() {
              ...
              this._isVisible
                ? wm(t)
                : this._balloon.hasView(this._toolbar) ||
                  this._balloon.add({
                    view: this._toolbar,
                    position: vm(t),
                    balloonClassName: Lg,
